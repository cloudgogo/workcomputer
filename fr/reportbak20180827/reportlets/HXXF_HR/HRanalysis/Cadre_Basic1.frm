...
SELECT A.HYLEIBIE,
  ...
  LEFT JOIN A
    ON YGTZ.YGID = A.YGID
   WHERE YGTZ.YGFENLEI = '干部'
   AND (SYSDATE - RZDATE)/365 < 5
...
${if(len(DWMC)=0,""," and VW.BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
 GROUP BY XZJIBIE
...
<O>
<![CDATA[/WebReport/ReportServer?formlet=HXXF_HR/HRanalysis/Cadre_Basic1.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[Cadre_Basic1.frm]]></O>
</ColumnConfig>
...
<WidgetName name="bceb7f22-f989-4bb0-9300-459b69f461c1"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
...
<Content>
<![CDATA[var url=FR.cjkEncode('/WebReport/ReportServer?reportlet=HXXF_HR%2FHRanalysis%2Fzuanqu_ganbu_2.cpt&DWMC='+DWMC+'&XZJIBIE='+XZJIBIE+'&YGFL='+YGFL)
...
<BoundsAttr x="0" y="0" width="958" height="362"/>
</Widget>
...
<BoundsAttr x="0" y="700" width="958" height="362"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Content>
<![CDATA[var url=FR.cjkEncode('/WebReport/ReportServer?reportlet=HXXF_HR%2FHRanalysis%2Fzuanqu_ganbu_2.cpt&DWMC='+DWMC+'&HYLEIBIE='+HYLEIBIE+'&YGFL='+YGFL)
//alert(url)
window.parent.parent.parent.$('#iframe2').attr('src',url);
window.parent.parent.parent.$('.smallIframe').show();
window.parent.parent.parent.$('.model').show();
...
<BoundsAttr x="0" y="0" width="958" height="350"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart5"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="350" width="958" height="350"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
var url=FR.cjkEncode('/WebReport/ReportServer?reportlet=HXXF_HR/HRanalysis/zuanqu_ganbu_2.cpt&DWMC='+DWMC+'&GZLEIXING='+GZLEIXING+'&YGFL='+YGFL);
//alert(url)
window.parent.parent.parent.$('#iframe2').attr('src',url);
window.parent.parent.parent.$('.smallIframe').show();
window.parent.parent.parent.$('.model').show();
...
<Size width="958" height="1062"/>
<ResolutionScalingAttr percent="1.2"/>
<tabFitAttr index="0" tabNameIndex="7"/>
</Widget>
...
<TemplateID TemplateID="56f74f5d-19e8-4ecf-ab96-0424eafe1d8d"/>
</Form>
