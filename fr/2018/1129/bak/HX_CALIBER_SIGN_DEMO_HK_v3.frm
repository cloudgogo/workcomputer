...
datetable as
 ...
 DIMINDEX as(
SELECT 'a70d438288bf42519b2d3b2e2a3509d3' as TARGETID,'产业新城全口径回款' as name,	1	as LEVELID,'201010' as TARGETRUM from dual
),
w1 as (
select    org_id ,
		targetid,
...
datetable as
 ...
 DIMINDEX as(
SELECT 'a70d438288bf42519b2d3b2e2a3509d3' as TARGETID,'产业新城全口径回款' as name,	1	as LEVELID,'201010' as TARGETRUM from dual UNION ALL
SELECT '86194f8be66641089909932d90f07fcc' as TARGETID,'住宅回款' as name,	2	as LEVELID,'203010' as TARGETRUM from dual UNION ALL
SELECT '8af4664d0837409a9b63736bb1630c9e' as TARGETID,'产业新城回款' as name,	2	as LEVELID,'202020' as TARGETRUM from dual
...
<Attributes>
<![CDATA[=if(len($info)=0,"",
$info+":"+"/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_HK_Last.cpt")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
<BoundsAttr x="452" y="64" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="469" y="40" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="393" y="39" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="536" y="39" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
window.parent.parent.FS.tabPane.addItem({title:"经营性回款详情",src:"${servletURL}?reportlet=/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_HK_Last.cpt&op=view&org="+ org2 +"&state=0"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<HighlightList>
...
<![CDATA[var sql=" select org_code from dim_org where org_id ='"+ORG+"'";
var  org2=FR.remoteEvaluate('sql("oracle_test","'+sql+'",1,1)');
window.parent.FS.tabPane.addItem({title:"经营性回款详情",src:"${servletURL}?reportlet=/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_HK_Last.cpt&op=view&org="+ org2 +"&state=1"})]]></Content>
</JavaScript>
</NameJavaScript>
...
<Attr url="=if($org=&quot;E0A3D386-D5C8-FB22-18DE-4424D49363B2&quot;,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FHX_CALIBER_SIGN_Form14.frm&amp;top=0&amp;org=E0A3D386-D5C8-FB22-18DE-4424D49363B1&quot;,if(sql(&quot;oracle_test&quot;,&quot;SELECT ORG_LEVEL from DIM_ORG_JXJL WHERE org_id=&apos;&quot;+ $org +&quot;&apos;&quot;,1,1)=3,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FForm9.frm&quot;,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FHX_CALIBER_SIGN_Form8.frm&quot;))"/>
</RHIframeSource>
<Parameters>
<Parameter>
<Attributes name="org"/>
...
<Attr path="/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_Book38.cpt&amp;op=view"/>
</RHIframeSource>
<Parameters>
<Parameter>
<Attributes name="org"/>
...
<Compare op="0">
<O>
<![CDATA[a70d438288bf42519b2d3b2e2a3509d3]]></O>
</Compare>
</Condition>
<Complex/>
...
<Compare op="0">
<O>
<![CDATA[8af4664d0837409a9b63736bb1630c9e]]></O>
</Compare>
</Condition>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.SummaryGrouper">
...
<Compare op="0">
<O>
<![CDATA[86194f8be66641089909932d90f07fcc]]></O>
</Compare>
</Condition>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.SummaryGrouper">
...
<TemplateID TemplateID="83d96c2e-3c96-4aea-9509-be661620a6d1"/>
