...
AND TO_CHAR(LZDATE,'YYYYMMDD')<TO_CHAR(SYSDATE,'YYYYMMDD')
And to_char(LZDATE,'YYYY') = to_char(SYSDATE,'YYYY')
AND LZYUANYIN IS NOT NULL
${if(len(NIANDU)=0,"and to_char(LZDATE,'YYYY') = to_char(SYSDATE,'YYYY')","and to_char(LZDATE,'YYYY-MM') = to_char(SYSDATE,'YYYY-MM')")}
${if(len(DWMC)=0,""," and BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
...
AND ISZHUYING = '主营'
AND TO_CHAR(LZDATE,'YYYYMMDD')<TO_CHAR(SYSDATE,'YYYYMMDD')
${if(len(NIANDU)=0,"and CQTCDLYEAR = '2011'","and CQTCDLYEAR ='"+NIANDU+"'")}
${if(len(DWMC)=0,""," and BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
...
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
GROUP BY HRSTATUS,ZHINENGXULIE))
WHERE HRSTATUS='I'
order by renshu desc]]></Query>
</TableData>
<TableData name="常青藤（主营）离职人数最高的TOP15及常青藤保存率" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
FROM(
SELECT
1- RATIO_TO_REPORT(renshu) OVER(partition by XUEXIAO) AS zhanbi,
renshu,
XUEXIAO,
HRSTATUS
FROM(
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/HRanalysis/Entry_Lvy.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[Entry_Lvy.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT_NAME" isKey="false" skipUnmodified="false">
<O>
<![CDATA[常青藤分布_常青藤离职分布]]></O>
</ColumnConfig>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($NIANDU)=0,"本年度","本月度")+"各单位常青藤离职人数"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<BoundsAttr x="271" y="0" width="685" height="256"/>
</Widget>
...
<BoundsAttr x="271" y="600" width="685" height="256"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($NIANDU)=0,"本年度","本月度")+"试用期内离职"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<BoundsAttr x="0" y="0" width="271" height="256"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="0" y="600" width="271" height="256"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($NIANDU)=0,"本年度","本月度")+"常青藤（主营）离职类型"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<BoundsAttr x="0" y="0" width="474" height="300"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart1"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="300" width="474" height="300"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="318" y="0" width="319" height="300"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($NIANDU)=0,"本年度","本月度")+"常青藤（主营）离职原因"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<BoundsAttr x="474" y="0" width="482" height="300"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart7"/>
<WidgetAttr description="">
...
<BoundsAttr x="474" y="300" width="482" height="300"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="637" y="0" width="319" height="300"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<MeterTable201109 meterType="1" name="RENSHU" value="ZHANBI"/>
</MeterTableDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="318" height="300"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="0" width="956" height="271"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart9"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="311" width="956" height="271"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="560" y="0" width="396" height="274"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart6"/>
<WidgetAttr description="">
...
<BoundsAttr x="560" y="582" width="396" height="274"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="0" width="560" height="274"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart5"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="582" width="560" height="274"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="475" y="0" width="481" height="311"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[各年度常青藤离职人数及保存率]]></Name>
</TableData>
<CategoryName value="CQTCDLYEAR"/>
<ChartSummaryColumn name="RENSHU" function="com.fr.data.util.function.NoneFunction" customName="常青藤人数"/>
</MoreNameCDDefinition>
</DefinitionMap>
...
<BoundsAttr x="0" y="0" width="475" height="311"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<O>
<![CDATA[常青藤（主营）离职人数最高的TOP15及常青藤保存率]]></O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
</Attr>
...
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[常青藤（主营）离职人数最高的TOP15及常青藤保存率]]></Name>
</TableData>
...
<BoundsAttr x="0" y="0" width="956" height="298"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="0" y="558" width="956" height="298"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart10"/>
...
<BoundsAttr x="355" y="0" width="601" height="273"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart10"/>
<WidgetAttr description="">
...
<BoundsAttr x="355" y="285" width="601" height="273"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="0" width="355" height="273"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="285" width="355" height="273"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart3"/>
...
<BoundsAttr x="476" y="0" width="480" height="285"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="0" width="476" height="285"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<TemplateID TemplateID="339223f7-84fe-447e-bb38-28cbff718a49"/>
</Form>
