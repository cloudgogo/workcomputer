...
<BoundsAttr x="626" y="1" width="200" height="25"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
window.parent.FS.tabPane.addItem({title:"配套取地详情",src:"${servletURL}?reportlet=ThreeLevelPage/HX_JYFX_MATCH_TAKE_LAND_THREEV1.cpt&op=view&is_show="+flag+"&org="+org})]]></Content>
</JavaScript>
</NameJavaScript>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[288000,432000,1008000,1008000,2160000,2160000,2160000,2160000,1008000,1008000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<VanChartColumnPlotAttr seriesOverlapPercent="0.0" categoryIntervalPercent="35.0" fixedWidth="false" columnWidth="25" filledWithImage="false" isBar="false"/>
</VanChartPlot>
...
<RichChar styleIndex="2">
<text>
<![CDATA[${=if(or(b11=0,len(b11)=0),'0',round(e11/b11,2)*100)}]]></text>
</RichChar>
<RichChar styleIndex="1">
<text>
<![CDATA[%]]></text>
...
<TemplateID TemplateID="8f45f08f-9ba2-4659-aa66-978038686fce"/>
