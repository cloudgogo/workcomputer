...
SELECT 
    case when ORG_ID='E0A3D386-D5C8-FB22-18DE-4424D49363B1' then 'E0A3D386-D5C8-FB22-18DE-4424D49363B2' else ORG_ID end ORG_ID,
    null  FATHER_ID,
    ORG_NAME,
    ORG_SNAME,
    ORDER_KEY,
...
SELECT
 ORG_ID,
     case when FATHER_ID='E0A3D386-D5C8-FB22-18DE-4424D49363B1' then 'E0A3D386-D5C8-FB22-18DE-4424D49363B2' else FATHER_ID end FATHER_ID,
    ORG_NAME,
    ORG_SNAME,
    ORDER_KEY,
    org_level,
    ORG_CODE
FROM ORG_JG where ORG_ID not in(select ORG_ID from dim_org_jxjl where org_level=(select min(org_level) from  ORG_JG ))
...
<Query>
<![CDATA[with org as(
SELECT ORG_ID,ORG_NAME,ORG_NUM FROM dim_org_jxjl  where org_id = '${org}'
AND ISSHOW=1
${if(len(org)=0,"",if(org='E0A3D386-D5C8-FB22-18DE-4424D49363B2',"UNION ALL SELECT ORG_ID,'华夏幸福' ORG_NAME,ORDER_KEY as ORG_NUM FROM dim_org  where org_id ='E0A3D386-D5C8-FB22-18DE-4424D49363B2'",""))}
),--组织
datetable as
 (
  --季度年度情况
  select distinct 
           to_char(p.period_date, 'yyyy') || 'Q' ||to_char(p.period_date, 'Q') CODE,
           to_char(p.period_date, 'Q') || '季度' description,
           to_char(p.period_date, 'yyyy') || 'Q' ||to_char(p.period_date, 'Q') ordercode
    FROM dim_period p
 ...
 DIMINDEX as(
SELECT '91e5853dd25b45a79cb6270e0ce8fd77' as TARGETID,'产业新城全口径签约' as name,	1	as LEVELID,'101010' as TARGETRUM from dual 
...
select 
*
from (select t1.* from dm_mcl_acct_resign t1 inner join w1 on t1.org_id = w1.org_id
	and t1.targetid = w1.targetid
	and t1.factdate = w1.factdate and t1.data_date = w1.data_date)
  )
...
d.PREDICT_RATE 
FROM org a
LEFT JOIN DIMINDEX b
on 1=1
LEFT JOIN datetable c
on 1=1
LEFT JOIN acct_resign d
ON a.org_id=d.org_id
and b.TARGETID=d.targetid
and c.code=d.factdate
where  b.TARGETRUM LIKE '1%' 
  and b.name<>'运营回款'
ORDER BY a.ORG_NUM,b.TARGETRUM,c.ordercode]]></Query>
</TableData>
<TableData name="SHUJU" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="org"/>
<O>
<![CDATA[E0A3D386-D5C8-FB22-18DE-4424D49363B2]]></O>
</Parameter>
<Parameter>
<Attributes name="periodtype"/>
<O>
...
datetable as
 ( --年度无论何时都需要显示
  select to_char(SYSDATE, 'yyyy') code,
          to_char(SYSDATE, 'yyyy') || '年' description,
          to_char(SYSDATE, 'yyyy') ordercode
    from dual
     where '${periodtype}' = '0'   
   union all
  --季度季度及月度的情况
  select distinct to_char(p.period_date, 'yyyy') || 'Q' ||
 ...
 DIMINDEX as(
SELECT '950a32bd2049444692f2db5d7ddbfafc' as TARGETID,'住宅签约' as name,2 as LEVELID,'103010' as TARGETRUM from dual UNION ALL
SELECT '3e927b5caa3a4d38b51a2bae096d73d3' as TARGETID,'产业新城签约' as name,	2	as LEVELID,'102020' as TARGETRUM from dual UNION ALL
SELECT '91e5853dd25b45a79cb6270e0ce8fd77' as TARGETID,'产业新城全口径签约' as name,	1	as LEVELID,'101010' as TARGETRUM from dual 
...
from (select t1.* from dm_mcl_acct_resign t1 inner join w1 on t1.org_id = w1.org_id
	and t1.targetid = w1.targetid
	and t1.factdate = w1.factdate and t1.data_date = w1.data_date
	--and t1.PREDICT_VAL=w1.PREDICT_VAL
	)
  )
...
d.ACTUAL_VAL,
d.PREDICT_VAL,
case when d.TARGET_VAL=0 or d.TARGET_VAL is null  then 0 
else nvl(d.PREDICT_VAL,0)/d.TARGET_VAL  end PREDICT_rate,
--d.PREDICT_VAL,
d.SAME_RATE,
d.TARGET_RATE,
d.PREDICT_RATE 
...
var sql=" select case when FATHER_ID='E0A3D386-D5C8-FB22-18DE-4424D49363B1' then '华夏幸福' else org_name  end org_name  from dim_org where org_id ='"+deptcode+"'";
...
<widgetValue>
<databinding>
<![CDATA[{Name:Tree1,Key:ORG_ID}]]></databinding>
</widgetValue>
</InnerWidget>
...
<BoundsAttr x="207" y="10" width="62" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="9" y="10" width="44" height="21"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<Position position="0"/>
<Design_Width design_width="790"/>
<NameTagModified>
<TagModified tag="treeComboBoxEditor0" modified="true"/>
</NameTagModified>
<WidgetNameTagMap>
...
if(len($periodtype)=0,"",switch($periodtype,"0","当年","1","当季","2","当月")+";")]]></Attributes>
</O>
</ColumnConfig>
...
if(len($periodtype)=0,"","periodtype:"+switch($periodtype,"0","当年","1","当季","2","当月")+";")]]></Attributes>
</O>
</ColumnConfig>
...
<Attributes>
<![CDATA[=if(len($info)=0,"",
$info+":"+"/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_QY_Last.cpt")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[if( $periodtype = $periodtype99  , 1<0 , 0<1 )
]]></Formula>
</Condition>
</JoinCondition>
<JoinCondition join="1">
...
<BoundsAttr x="355" y="35" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="635" y="31" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="547" y="39" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="458" y="34" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Content>
<![CDATA[var sql=" select org_code from dim_org where org_id ='"+ORG+"'";
var  org2=FR.remoteEvaluate('sql("oracle_test","'+sql+'",1,1)');
window.parent.parent.FS.tabPane.addItem({title:"签约详情",src:"${servletURL}?reportlet=/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_QY_Last.cpt&op=view&org="+ org2 +"&state=0"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<HighlightList>
...
<![CDATA[var sql=" select org_code from dim_org where org_id ='"+ORG+"'";
var  org2=FR.remoteEvaluate('sql("oracle_test","'+sql+'",1,1)');
window.parent.FS.tabPane.addItem({title:"签约详情",src:"${servletURL}?reportlet=/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_DEMO_QY_Last.cpt&op=view&org="+ org2 +"&state=1"})]]></Content>
</JavaScript>
</NameJavaScript>
...
<BoundsAttr x="790" y="238" width="59" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.plugin.form.widget.core.RHIframe" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<WidgetName name="rHIframe0"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Attr scrollX="true" scrollY="true"/>
<RHIframeAttr class="com.fr.plugin.form.widget.core.RHIframeAttr" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<RHIframeSource class="com.fr.plugin.form.widget.core.URLSource" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<Attr url="=if($org=&quot;E0A3D386-D5C8-FB22-18DE-4424D49363B2&quot;,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FHX_CALIBER_SIGN_Form13.frm&amp;top=0&amp;org=E0A3D386-D5C8-FB22-18DE-4424D49363B1&quot;,if(sql(&quot;oracle_test&quot;,&quot;SELECT ORG_LEVEL from DIM_ORG_JXJL WHERE org_id=&apos;&quot;+ $org +&quot;&apos;&quot;,1,1)=3,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FForm9.frm&quot;,&quot;http://10.20.60.47:8080/WebReport/ReportServer?formlet=HX_CALIBER_ACHIEVEMENT%2FHX_CALIBER_SIGN_Form7.frm&quot;))"/>
</RHIframeSource>
<Parameters>
<Parameter>
<Attributes name="org"/>
...
<BoundsAttr x="582" y="5" width="273" height="212"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[228600,1143000,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[4381500,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="1" s="0">
<O>
<![CDATA[签约完成情况表]]></O>
...
<![CDATA[228600,1143000,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[266700,4381500,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<BoundsAttr x="13" y="230" width="238" height="28"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="report2"/>
...
<![CDATA[228600,1143000,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[4953000,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<![CDATA[228600,1143000,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[228600,4953000,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<BoundsAttr x="13" y="1" width="238" height="28"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.plugin.form.widget.core.RHIframe" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<WidgetName name="rHIframe1"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Attr scrollX="true" scrollY="true"/>
<RHIframeAttr class="com.fr.plugin.form.widget.core.RHIframeAttr" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<RHIframeSource class="com.fr.plugin.form.widget.core.TemplateSource" pluginID="com.fr.solution.plugin.form.widget.rh.iframe">
<Attr path="/HX_CALIBER_ACHIEVEMENT/HX_CALIBER_SIGN_Book37.cpt&amp;op=view"/>
</RHIframeSource>
<Parameters>
<Parameter>
<Attributes name="org"/>
...
<BoundsAttr x="16" y="260" width="832" height="215"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Background name="ColorBackground" color="-16442822"/>
<Alpha alpha="1.0"/>
</Border>
<Background name="ColorBackground" color="-16442822"/>
<FormElementCase>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[1440000,864000,1440000,1728000,1440000,1440000,1440000,1440000,864000,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[576000,2743200,4608000,3456000,3168000,10080000,10080000,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<ColorList>
<OColor colvalue="-16735489"/>
<OColor colvalue="-16712705"/>
<OColor colvalue="-14063873"/>
...
<newLineColor lineColor="-14331025"/>
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=max(value(&quot;Column&quot;, 10), value(&quot;Column&quot;, 11)) * 1.4"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<![CDATA[#0%]]></Format>
<AxisLabelCount value="=1"/>
<AxisRange minValue="=-0.03" maxValue="=if(max(value(&quot;Column&quot;, 14), value(&quot;Column&quot;, 14)) = 0, 1, max(value(&quot;Column&quot;, 14), value(&quot;Column&quot;, 14)) * 1.2)"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<ChartSummaryColumn name="TARGET_VAL" function="com.fr.data.util.function.NoneFunction" customName="目标"/>
<ChartSummaryColumn name="ACTUAL_VAL" function="com.fr.data.util.function.NoneFunction" customName="实际"/>
</MoreNameCDDefinition>
</DefinitionMap>
...
<CategoryName value="DESCRIPTION"/>
<ChartSummaryColumn name="TARGET_RATE" function="com.fr.data.util.function.NoneFunction" customName="完成率"/>
</MoreNameCDDefinition>
</DefinitionMap>
</DefinitionMapList>
</CustomDefinition>
...
<text>
<![CDATA[${=if(B12=0,0,if(len(B12)=0,0,ROUND(B12,1)))}]]></text>
</RichChar>
...
<text>
<![CDATA[${=if(B15=0,0,if(len(B15)=0,0,ROUND(B15,1)))}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[亿]]></text>
...
<RichChar styleIndex="5">
<text>
<![CDATA[${=if(B18=0,0,if(len(B18)=0,0,ROUND(B18,1)))}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[亿]]></text>
...
<RichChar styleIndex="3">
<text>
<![CDATA[${=switch($periodtype,'0',"年度",'1',"季度",'2',"月度")}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[目标  ]]></text>
...
<text>
<![CDATA[${=if(b11=0,0,if(len(b11)=0,0,ROUND(b11,1)))}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[亿]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(b14=0,0,if(len(b14)=0,0,ROUND(b14,1)))}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[亿]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(b17=0,0,if(len(b17)=0,0,ROUND(b17,1)))}]]></text>
</RichChar>
<RichChar styleIndex="3">
<text>
<![CDATA[亿]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B13=0,0,if(len(B13)=0,0,ROUND(B13,3)*100))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B16=0,0,if(len(B16)=0,0,ROUND(B16,3)*100))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B19=0,0,if(len(B19)=0,0,ROUND(B19,3)*100))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B22=0,0,if(len(B22)=0,0,ROUND(B22*100,1)))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B23=0,0,if(len(B23)=0,0,ROUND(B23*100,1)))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<RichChar styleIndex="6">
<text>
<![CDATA[${=if(B24=0,0,if(len(B24)=0,0,ROUND(B24*100,1)))}]]></text>
</RichChar>
<RichChar styleIndex="6">
<text>
<![CDATA[%]]></text>
...
<C c="1" r="10">
<O t="DSColumn">
<Attributes dsName="SHUJU" columnName="TARGET_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
<![CDATA[TARGETID]]></CNAME>
<Compare op="0">
<O>
<![CDATA[91e5853dd25b45a79cb6270e0ce8fd77]]></O>
</Compare>
</Condition>
<Complex/>
...
<C c="1" r="11">
<O t="DSColumn">
<Attributes dsName="SHUJU" columnName="ACTUAL_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="1" r="12">
<O t="DSColumn">
<Attributes dsName="SHUJU" columnName="TARGET_RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<Compare op="0">
<O>
<![CDATA[3e927b5caa3a4d38b51a2bae096d73d3]]></O>
</Compare>
</Condition>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.SummaryGrouper">
...
<Compare op="0">
<O>
<![CDATA[950a32bd2049444692f2db5d7ddbfafc]]></O>
</Compare>
</Condition>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.SummaryGrouper">
...
<C c="1" r="19">
<O t="DSColumn">
<Attributes dsName="SHUJU" columnName="PREDICT_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="1" r="20">
<O t="DSColumn">
<Attributes dsName="SHUJU" columnName="PREDICT_RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<Style imageLayout="1">
<FRFont name="微软雅黑" style="0" size="216" foreground="-16712705"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style imageLayout="1">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,2160000,2880000,288000,2880000,2880000,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[576000,10080000,10080000,10080000,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<RichChar styleIndex="3">
<text>
<![CDATA[其中：新城目标800亿，完成656亿，完成率82%
          住宅目标360亿，完成264亿，完成率73.7%]]></text>
</RichChar>
</RichText>
</O>
<PrivilegeControl/>
...
<Margin top="0" left="0" bottom="0" right="0"/>
<Border>
<border style="1" color="-16698031" borderRadius="0" type="0" borderStyle="0"/>
<WidgetTitle>
<O>
<![CDATA[新建标题]]></O>
<FRFont name="宋体" style="0" size="72"/>
...
<Background name="ColorBackground" color="-16767940"/>
<Alpha alpha="1.0"/>
</Border>
<Background name="ColorBackground" color="-16767940"/>
<FormElementCase>
...
<BoundsAttr x="8" y="231" width="844" height="247"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="f15b7f8b-0a31-4217-bcd4-517bc853d59b"/>
<TemplateIdAttMark class="com.fr.base.iofileattr.TemplateIdAttrMark">
<TemplateIdAttMark TemplateId="ccea4120-8e1f-49a1-bb57-57e5b2eda1e2"/>
</TemplateIdAttMark>
</Form>
