...
<Query>
<![CDATA[select * from JXJL_DH]]></Query>
</TableData>
...
with data_time as
 (select 
    ${SWITCH(periodtype, "当年",  "substr(a.data_date, 1, 4) data_date",
                "当季", " substr(a.data_date, 1, 4) || to_char(to_date(a.data_date, 'YYYYMMDD'), 'Q') data_date",
                "当月",  " substr(a.data_date, 1, 4) || to_char(to_date(a.data_date, 'YYYYMMDD'), 'MM') data_date ") }
   from dm_ncf_netcashflow a
   where 1 = 1
     and a.data_date is not null
     and rownum = 1),
netcashflow as(
select * from dm_ncf_netcashflow a
where a.guid = '${org}'
and a.calibre = '5a7354d69ad84e1cba378279096c4157'
 ${SWITCH(periodtype, "当年",  " and a.date_type='年' ",
                "当季", " and a.date_type='季' ",
                "当月",  " and a.date_type='月' ") }
),

ncf_index as(
select * from dim_ncf_index i
where i.serialnumber = 'JXJL01'
)

select  *  from (
select '目标' type1, a.gname , a.target as zhi, (a.target - a.fact) c
  from netcashflow a, ncf_index i, data_time t
 where 1 = 1
 and a.date_string=t.data_date
   and a.index_id = i.guid
   and exists (select org_id
                  from dim_org_jxjl o
...
select '实际' type1, a.gname  , a.fact as zhi, (a.target - a.fact) c 
  from netcashflow a, ncf_index i, data_time t
 where 1 = 1
   and a.index_id = i.guid
   and a.date_string=t.data_date
...
data1 as
 (select i.names, i.serialnumber, a.date_string, a.target, a.fact
    from dm_ncf_netcashflow a, dim_ncf_index i
   where 1 = 1
      and a.index_id = i.guid
     and a.guid = '${org}'
     --and i.serialnumber = 'JXJLJY010103'
     and i.serialnumber in ('JXJLCZ03', 'JXJLJY03', 'JXJLTZ03')
...
select type1, period_name, rn, rn2, nvl(fact,0) as fact from (
	select '含筹资性' type1, period_name, rn, 2 rn2, sum(fact) fact from (
	select *
	  from data_time t
	  left join data1 d
	    on t.period_type_id = d.date_string
	)
	group by period_name, rn
	
	union all
	
	select '不含筹资性' type1, period_name, rn, 3 rn2, sum(fact) fact from (
	select *
	  from data_time t
	  left join data1 d
	    on t.period_type_id = d.date_string
...
where 1=1
and serialnumber<>'JXJLCZ03'
group by period_name, rn

union all

select '目标' type1, period_name, rn, 1 rn2, sum(target) target from (
select *
  from data_time t
  left join data1 d
    on t.period_type_id = d.date_string
...
order by rn2, rn, period_name]]></Query>
</TableData>
        ...
        select distinct a.guid,
         ...
         where 1 = 1
           ...
           and i.serialnumber in
               ('JXJLCZ03', 'JXJLJY03', 'JXJLTZ03', 'JXJL01')
...
--                       ('产业新城（国内）', '产业新城（国际）') or org_level = 1)
           ...
           and (a.date_string in (data_time_q.year1, data_time_q.quar) or
               a.date_string in (data_time_q.mon, data_time_q.mon + 1, data_time_q.mon + 2))
 ...
 where 1 = 1
   and guid = org_id
 order by org_num,to_number(date_string),  to_number(ordernum)
]]></Query>
</TableData>
...
<BoundsAttr x="314" y="34" width="34" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.TextEditor">
...
<BoundsAttr x="374" y="1" width="35" height="20"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.TreeComboBoxEditor">
...
<BoundsAttr x="405" y="2" width="95" height="18"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,5715000,7200000,3744000,3744000,3744000,3744000,3744000,3744000,3744000,3744000,3744000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<C c="5" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="mingxb" columnName="C"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<![CDATA[864000,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[8686800,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<O>
<![CDATA[净现金流完成趋势]]></O>
...
<BoundsAttr x="336" y="3" width="221" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[1152000,1440000,864000,864000,864000,864000,864000,864000,1008000,720000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[288000,3600000,3600000,3600000,3600000,288000,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
...
<AxisLabelCount value="=1"/>
<AxisRange minValue="=if(min(value(&quot;wancqs&quot;, 5))&gt;0,0,min(value(&quot;wancqs&quot;, 5))* 1.3)" maxValue="=max(value(&quot;wancqs&quot;, 5)) * 1.9"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="TYPE1" valueName="FACT" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[wancqs]]></Name>
...
<BoundsAttr x="330" y="1" width="523" height="231"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[1008000,432000,1008000,1008000,1008000,1008000,1008000,1008000,1008000,1008000,1008000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,1440000,3600000,3600000,3600000,288000,1440000,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" cs="4" s="0">
<PrivilegeControl/>
<Expand/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<span style='font-size:12px;color:#ffffff;font-family:微软雅黑;'>净现金流差额&nbsp;&nbsp;&nbsp;</span><span style='font-size:18px;color:#00ffff;font-family:微软雅黑;'>" +ROUND(C12[C12:!1]A,1) + "</span>"]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<AxisLabelCount value="=1"/>
<AxisRange minValue="=if(len(value(&quot;yusdb&quot;,3))=0,0,if( min(value(&quot;yusdb&quot;,3)&gt;0),0,min(value(&quot;yusdb&quot;,3))*1.6))" maxValue="=if(len(value(&quot;yusdb&quot;,3))=0,0,max(value(&quot;yusdb&quot;,3))*1.3+1)"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<ChartSummaryColumn name="ZHI" function="com.fr.data.util.function.NoneFunction" customName="ZHI"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
...
<C c="2" r="11">
<O t="DSColumn">
<Attributes dsName="yusdb" columnName="C"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="8" y="1" width="312" height="231"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="report2"/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[0,288000,864000,228600,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,3352800,288000,3600000,288000,3600000,288000,3312000,5040000,3456000,288000,2304000,288000,2304000,288000,2304000,17280000,4608000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<BoundsAttr x="145" y="19" width="707" height="30"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="058aa304-197d-48de-a11f-86a65010b2b7"/>
