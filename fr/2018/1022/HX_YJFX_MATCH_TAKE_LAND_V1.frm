...
select round(nvl(a.target_value, 0)) target_value,
       ...
       case
         when nvl(a.target_value, 0) = 0 then
          ...
          round(nvl(a.actual_value, 0) / nvl(a.target_value, 0), 4)
       end rate_value
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[288000,762000,1008000,152400,1008000,190500,1008000,76200,1143000,533400,1008000,1008000,1008000,723900,0,0,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[288000,720000,2743200,2743200,2743200,2743200,2895600,5486400,1728000,1728000,1728000,1728000,1728000,1728000,1728000,1728000,1728000,457200,1143000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<TemplateID TemplateID="6a205e37-63d5-4f60-8090-7172606cf76e"/>
