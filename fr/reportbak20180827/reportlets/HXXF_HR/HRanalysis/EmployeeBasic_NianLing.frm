...
<TableDataMap>
<TableData name="年代分布_总数" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
<Query>
<![CDATA[SELECT
ROUND(ratio_to_report(RENSHU) OVER(),3) AS ZHANBI,
年代,
RENSHU
FROM
(
SELECT '70前' AS 年代,
  ...
  FROM ODM_HR_YGTZ B
 WHERE 1=1
   AND B.CSDATE <= TO_DATE('1969-12-31','YYYY-MM-DD')
...
SELECT '70后' AS 年代,
  ...
  FROM ODM_HR_YGTZ C
 WHERE 1=1
   AND C.CSDATE >= TO_DATE('1970-01-01','YYYY-MM-DD')
   AND C.CSDATE <= TO_DATE('1979-12-31','YYYY-MM-DD')
${if(len(DWMC)=0,""," and BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
...
SELECT '80后' AS 年代,
  ...
  FROM ODM_HR_YGTZ D
 WHERE 1=1
   AND D.CSDATE >= TO_DATE('1980-01-01','YYYY-MM-DD')
   AND D.CSDATE <= TO_DATE('1989-12-31','YYYY-MM-DD')
${if(len(DWMC)=0,""," and BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
...
SELECT '90后' AS 年代,
  ...
  FROM ODM_HR_YGTZ E
 WHERE 1=1
   AND E.CSDATE >= TO_DATE('1990-01-01','YYYY-MM-DD')
...
<TableData name="年代分布_主营" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="年代分布_干部" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="年代分布_职级" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<Query>
<![CDATA[SELECT '70前' AS 年代,
       ROUND(AVG(SUBSTR(ZHIJI,1,2)),2) AS AVGZHIJI
  FROM ODM_HR_YGTZ B
 WHERE 1=1
   AND B.CSDATE <= TO_DATE('1969-12-31','YYYY-MM-DD')
${if(len(DWMC)=0,""," and BUMENID in(
...
<TableData name="整体年龄分布_1" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="整体年龄分布_2" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
<Query>
<![CDATA[SELECT '25岁及以下' AS FENLEI,
       COUNT(YGID) AS RENSHU
  FROM ODM_HR_YGTZ
 WHERE 1=1
${if(iszy == '总体' || len(iszy) == 0,"",if(iszy == '主营',"AND ISZHUYING = '主营'","AND ISZHUYING = '非主营'"))}  
...
<TableData name="整体年龄分布_3" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="iszy"/>
<O>
...
<Query>
<![CDATA[SELECT '男' AS XB,
       ROUND(
       AVG(ABS(TO_DATE(TO_CHAR(SYSDATE, 'YYYY-MM-DD'),'YYYY-MM-DD') 
	     - 
       TRUNC(TO_DATE(TO_CHAR(CSDATE, 'YYYY-MM-DD'),'YYYY-MM-DD')))
       ) / 365
       ,2) AS AVGNL
  FROM ODM_HR_YGTZ
 WHERE 1=1
...
<TableData name="整体年龄分布_4" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="iszy"/>
<O>
...
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
 GROUP BY ZHIJI
 ORDER BY ZHIJI]]></Query>
</TableData>
<TableData name="干部常青藤_2" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="干部常青藤_1" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="干部常青藤_4" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<TableData name="干部常青藤_3" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/FHRanalysis/EmployeeBasic_NianLing.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[EmployeeBasic_NianLing.frm]]></O>
</ColumnConfig>
...
<WidgetName name="b2bf69fd-3da7-420f-9cb0-f12d31256448"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Margin top="0" left="0" bottom="0" right="0"/>
...
<WidgetName name="02516114-4877-4ff6-ba97-fe1b220df3b1"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
...
<Widget class="com.fr.form.ui.CardSwitchButton">
<WidgetName name="5c2387dd-5232-4804-a080-383414c5dcdc"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
...
<Widget class="com.fr.form.ui.CardSwitchButton">
<WidgetName name="156d335d-9deb-4d5f-9fca-551b6d9df2a4"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
<![CDATA[干部/常青藤年龄分布]]></Text>
<FRFont name="SimSun" style="0" size="72"/>
<isCustomType isCustomType="true"/>
...
<![CDATA[80,93,80,80,80,80,80,80,80,80,80]]></ColumnWidth>
</Center>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(iszy) == 0,"不同职级平均年龄（总体）","不同职级平均年龄（"+iszy+"）")]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<VanAttrMarker>
<Attr isCommon="true" markerType="RoundMarker" radius="5.0" width="30.0" height="30.0"/>
<Background name="NullBackground"/>
</VanAttrMarker>
</Attr>
...
<AxisLabelCount value="=1"/>
<AxisRange minValue="=20" maxValue="=65"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<ChartSummaryColumn name="AVGNL" function="com.fr.data.util.function.NoneFunction" customName="平均年龄"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<BoundsAttr x="298" y="0" width="660" height="251"/>
</Widget>
...
<BoundsAttr x="298" y="251" width="660" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(iszy) == 0,"不同性别平均年龄（总体）","不同性别平均年龄（"+iszy+"）")]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<BoundsAttr x="0" y="0" width="298" height="251"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart6"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="251" width="298" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(iszy) == 0,"年龄区间分布（总体）","年龄区间分布（"+iszy+"）")]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="总体/主营/非主营平均年龄"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<![CDATA[_blank]]></TargetFrame>
<Features/>
<realateName realateValue="chart6"/>
<linkType type="0"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<BoundsAttr x="479" y="0" width="479" height="248"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr description="">
...
<BoundsAttr x="479" y="254" width="479" height="248"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-11250861"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<BoundsAttr x="479" y="0" width="479" height="254"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart2"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="0" width="479" height="248"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart1"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="254" width="479" height="248"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="0" width="479" height="254"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart0"/>
<WidgetAttr description="">
...
<isCustomFillStyle isCustomFillStyle="true"/>
<ColorList>
<OColor colvalue="-12747437"/>
<OColor colvalue="-11184811"/>
<OColor colvalue="-11217744"/>
<OColor colvalue="-16750485"/>
<OColor colvalue="-3658447"/>
<OColor colvalue="-10331231"/>
<OColor colvalue="-7763575"/>
...
<MeterTable201109 meterType="1" name="CQT" value="AVGNL"/>
</MeterTableDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="312" height="251"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart11"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="251" width="312" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<OColor colvalue="-4259832"/>
<OColor colvalue="-11184811"/>
<OColor colvalue="-7246266"/>
<OColor colvalue="-4685498"/>
<OColor colvalue="-3658447"/>
<OColor colvalue="-10331231"/>
<OColor colvalue="-7763575"/>
<OColor colvalue="-6514688"/>
...
<MeterTable201109 meterType="1" name="GB" value="AVGNL"/>
</MeterTableDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="313" height="251"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart9"/>
<WidgetAttr description="">
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-2328451"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<BoundsAttr x="312" y="0" width="646" height="251"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart10"/>
<WidgetAttr description="">
...
<BoundsAttr x="312" y="251" width="646" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="313" y="0" width="645" height="251"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart8"/>
<WidgetAttr description="">
...
<TemplateID TemplateID="285f930d-b98e-4f5c-96ff-ef69f85f3431"/>
</Form>
