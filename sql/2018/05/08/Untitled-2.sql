...
SELECT RESULT.SEG1,
          ...
          from (SELECT T.SEG1,
                  ...
                  FROM (select
                         ...
                         WHERE S.ROW_SET_NAME = 'P100V1'
                           ...
                           AND R.ROW_NUM =  '61'  --'${P_ROW_NUM}'   --2
                           AND R.ROW_NAME = '五、净利润(净亏损以“－”号填列)' --'${P_ROW_NAME}'  --2
 ...
 GROUP BY RESULT.SEG1, RESULT.SEG2, RESULT.ROW_NUM, RESULT.ROW_NAME,RESULT.SEGMENT3 --3
