...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($MENU, "常用报表工具") < 0, "", "<div class='newTitle'>"+G6+""+A5+""+B5+""+C5+""+D5+""+E5+""+F5+"</div>")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($MENU, "系统管理") < 0, "", "<div class='newTitle'>管理看板==/WebReport/ReportServer?formlet=HXXF_HR/Maneger/index.frm&username=" + username + "&userid=" + userid + "==icon-fenxi</div>")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($MENU, "常用报表工具") < 0, "", "<div class='newTitle'>常用报表工具==/WebReport/ReportServer?reportlet=HXXF_HR/ReportTool/Employee.cpt&username=" + username + "&userid=" + userid + "==icon-biaoge"+A5+""+B5+""+C5+""+D5+""+E5+""+F5+"</div>")]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(A6)<>0,A6,if(len(B6)<>0,B6,if(len(C6)<>0,C6,if(len(D6)<>0,D6,if(len(E6)<>0,E6,F6)))))]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<TemplateID TemplateID="0fa73a7a-8d1a-4990-b8a0-1ca2dd3a17a0"/>
</Form>
