...
select index_name, c.index_id,
	  decode(c.index_id, '81a24bfbfa9a45ebaf35ed9466b0e553', round(nvl(a.target_value, 0)), 'f1a3f1d86fe54ca0a3b7772fa55bb86f', round(nvl(a.target_value, 0)), '83f0488d1f7e45cf81f4875f9067438b', round(nvl(a.target_value, 0)),  
	  round(nvl(a.target_value, 1)) )
	   target_value,

	   decode(c.index_id, '81a24bfbfa9a45ebaf35ed9466b0e553', round(nvl(a.actual_value, 0)), 		'f1a3f1d86fe54ca0a3b7772fa55bb86f', round(nvl(a.actual_value, 0)),
'83f0488d1f7e45cf81f4875f9067438b', round(nvl(a.actual_value, 0)),
	   round(nvl(a.actual_value, 1)) )
        actual_value,
       case
 ...
 where 1 = 1
   ...
   and c.index_id in ( '81a24bfbfa9a45ebaf35ed9466b0e553','f1a3f1d86fe54ca0a3b7772fa55bb86f','83f0488d1f7e45cf81f4875f9067438b', 
   
   'd3b49d2f94bc4fa8896ba93d9a4abec6', 'bb7b4828db4c4a2780545730315193d3', 'c645c475bc5a4a64b9ec741926ac958a')
...
WHERE FATHER_ID='81a24bfbfa9a45ebaf35ed9466b0e553' 
...
DIM_INDEX2 AS (
SELECT INDEX_ID,INDEX_NAME,ORDER_KEY FROM DIM_INDEX 
WHERE INDEX_id = '81a24bfbfa9a45ebaf35ed9466b0e553'
), 
TARGET AS (
...
select CALIBER||'-' as CALIBER,zhibiao||'-'||decode(val,0,'',val) as zhibiao,index_name,value,val from (
select a.*,sum(value)over(partition by a.CALIBER,a.zhibiao) val from (
SELECT 
    a.CALIBER, --时间口径
    a.ORDER_CALIBER,
    ...
    case 
      when f.zhibiao='目标' then
        decode( index_name, '域内', '目标', '' )
     else d.index_name end index_name,
    ...
    case when f.zhibiao='目标'  then 
      decode(d.index_name, '域内', SUM(nvl(TAR.TARGET_VALUE, 0)), 0) 
...
ORDER BY ORDER_CALIBER,ORDER_KEY,xh
]]></Query>
</TableData>
<TableData name="ds3_mu" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="dim_cal"/>
<O>
...
select *
  from (select a.org_id,
         ...
         where 1 = 1
           and targetid = '81a24bfbfa9a45ebaf35ed9466b0e553'
...
<TableData name="ds3_wanping" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="dim_cal"/>
<O>
...
select *
  from (select a.org_id,
          ...
          from DM_MCL_RESIDENTIAL a
         where 1 = 1
           and targetid = 'd3b49d2f94bc4fa8896ba93d9a4abec6'
           and father_id is not null
           and a.factdate = (select * from factdate)
...
<TableData name="ds2_lv" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="dim_cal"/>
<O>
...
DIM_ORF_HX AS
 (SELECT ORG_ID, ORG_NAME FROM DIM_ORG where org_id = 'E0A3D386-D5C8-FB22-18DE-4424D49363B2' ) --产业新城维度
...
<BoundsAttr x="483" y="4" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<![CDATA[1440000,2160000,2160000,1440000,1440000,1008000,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" cs="6" s="0">
<O t="RichText">
<RichText>
...
<RichChar styleIndex="3">
<text>
<![CDATA[${=IF(len(c2)=0, 0, round(c2, 1) )}]]></text>
</RichChar>
<RichChar styleIndex="4">
<text>
<![CDATA[ ]]></text>
...
<Compare op="0">
<O>
<![CDATA[81a24bfbfa9a45ebaf35ed9466b0e553]]></O>
</Compare>
</Condition>
...
<Compare op="0">
<O>
<![CDATA[d3b49d2f94bc4fa8896ba93d9a4abec6]]></O>
</Compare>
</Condition>
<Complex reselect="true"/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
...
<Style imageLayout="1">
<FRFont name="微软雅黑" style="0" size="168" foreground="-1"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style imageLayout="1">
...
<BoundsAttr x="31" y="208" width="205" height="37"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<![CDATA[#0%]]></Format>
<AxisLabelCount value="=1"/>
<AxisRange minValue="=0" maxValue="=if(or(MAX(ds2_lv.GROUP(RATE_VALUE))=0, len(MAX(ds2_lv.GROUP(RATE_VALUE)))=0), 1, MAX(ds2_lv.GROUP(RATE_VALUE))*1.3)"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<BoundsAttr x="453" y="67" width="401" height="123"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<![CDATA[
    ...
    var wenjianmingcheng ="住宅取地分析";

    var org_code=this.getValue();
    var sql=" select org_name from dim_org where org_id='"+org_code+"' ";
    var org_name=FR.remoteEvaluate('=sql("oracle_test", " '+sql+' ", 1) ');

    var canshuming = "org"; //参数en
    var canshu=org_code;
    //this.options.form.getWidgetByName("org").getValue();
...
<BoundsAttr x="186" y="5" width="271" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="716" y="47" width="128" height="20"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[1296000,1152000,1152000,864000,864000,864000,864000,864000,864000,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[576000,6480000,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<C c="8" r="1" cs="5" s="1">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="TYPE2"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<PrivilegeControl/>
<Expand dir="1" leftParentDefault="false" left="B4"/>
</C>
<C c="13" r="1" cs="5" s="1">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="TYPE2"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=left(B10, 4) - 1 + "年"]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=left(B10, 4) - 1 + "年" + CEILING(C10 / 3) + "季度"]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=left(B10, 4) - 1 + "年" + C10 + "月"]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<C c="2" r="3" s="3">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="TARGET_NAME"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="3" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="TARGET_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="4" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="5" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="TARGET_RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="6" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="7" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_mu" columnName="LST_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="2" r="4" s="3">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="TARGET_NAME"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="3" r="4" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="TARGET_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="4" r="4" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="5" r="4" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="TARGET_RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="6" r="4" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="7" r="4" s="4">
<O t="DSColumn">
<Attributes dsName="ds3_wanping" columnName="LST_VAL"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=sql("oracle_test", " select data_date from dm_mcl_acct where rownum=1 ", 1)]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=sql("oracle_test", " select to_number(substr(data_date, 5, 2)) from dm_mcl_acct where rownum=1 ", 1)]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<BoundsAttr x="10" y="270" width="844" height="203"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="report0"/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[288000,1440000,1440000,864000,864000,864000,864000,864000,864000,864000,864000,1440000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[288000,1728000,1728000,1728000,1728000,432000,1440000,1440000,1440000,1440000,432000,2160000,2160000,2160000,2160000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=IF(or(MAX(ds2.GROUP(value)) = 0, len(MAX(ds2.GROUP(value))) = 0), 0, MAX(ds2.GROUP(value)) * 1.3)"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<OneValueCDDefinition seriesName="INDEX_NAME" valueName="VAL" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds2]]></Name>
</TableData>
<CategoryName value="ZHIBIAO"/>
<TableMoreCate>
...
<Compare op="0">
<O>
<![CDATA[f1a3f1d86fe54ca0a3b7772fa55bb86f]]></O>
</Compare>
</Condition>
<Complex reselect="true"/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
...
<Compare op="0">
<O>
<![CDATA[bb7b4828db4c4a2780545730315193d3]]></O>
</Compare>
</Condition>
<Complex reselect="true"/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
...
<Compare op="0">
<O>
<![CDATA[83f0488d1f7e45cf81f4875f9067438b]]></O>
</Compare>
</Condition>
<Complex reselect="true"/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
...
<Compare op="0">
<O>
<![CDATA[c645c475bc5a4a64b9ec741926ac958a]]></O>
</Compare>
</Condition>
<Complex reselect="true"/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
...
<BoundsAttr x="16" y="38" width="844" height="200"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="数据截止日期：" + sql("oracle_test", "select to_char(to_date(data_date, 'YYYY-MM-DD'), 'YYYY-MM-DD') from dm_mcl_acct where rownum=1", 1)+" / 单位：亩/万平"]]></Attributes>
</O>
</widgetValue>
...
<BoundsAttr x="618" y="5" width="236" height="21"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="cc6d2174-95df-428b-9067-d799276f890a"/>
