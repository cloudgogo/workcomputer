 ...
 */
 ...
 select sum(pro_qty) pro_qty,sum(fin_pro_qty) fin_pro_qty,sum(fin_pro_qty)/sum(pro_qty) rate,
${if(depttype1="事业部","org.事业部简称","org.区域简称")} ORG_SNAME from (
select distinct r.pro_qty pro_qty,
       ${if(len(house_sche)=0,"r.all_fill","r.fin_pro_qty")}  fin_pro_qty,
       decode(r.pro_qty,0,0,(${if(len(house_sche)=0,"r.all_fill","r.fin_pro_qty")} / r.pro_qty)) rate, 
       o.org_id
...
(select ofather.org_id    事业部id,
  ...
  left join (select * from dim_org where org_type ='区域') o
    on ofather.org_id = o.father_id) org
where res.org_id=org.区域id
 group by ${if(depttype1="事业部","org.事业部简称","org.区域简称")}
  ) res
 order by nvl(res.rate,0) ${if(ordertype1="前十名", "desc","asc")} , nvl(pro_qty,0) ${if(ordertype1="前十名", "desc","asc")}, NVL(pro_qty,0) ${if(ordertype1="前十名", "desc","asc")},ORG_SNAME) result
 where rownum <=10
...
<O>
<![CDATA[house_sche;org_classify;depttype;ordertype;depttype1;ordertype1]]></O>
</ColumnConfig>
<ColumnConfig name="CANSHU" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($house_sche)=0,"",$house_sche+";")+
if(len($org_classify)=0,"",$org_classify+";")+
if(len($depttype)=0,"",$depttype+";")+
if(len($ordertype)=0,"",$ordertype+";")+
if(len($depttype1)=0,"",$depttype1+";")+
if(len($ordertype1)=0,"",$ordertype1+";")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="CANSHUMINGYUCANSHU" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($house_sche)=0,"","house_sche:"+$house_sche+";")+
if(len($org_classify)=0,"","org_classify:"+$org_classify+";")+
if(len($depttype)=0,"","depttype:"+$depttype+";")+
if(len($ordertype)=0,"","ordertype:"+$ordertype+";")+
if(len($depttype1)=0,"","depttype1:"+$depttype1+";")+
if(len($ordertype1)=0,"","ordertype1:"+$ordertype1+";")]]></Attributes>
</O>
</ColumnConfig>
...
<Formula>
<![CDATA[if($house_sche=$house_sche99,1<0,0<1)]]></Formula>
</Condition>
</JoinCondition>
...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[if($ordertype1=$ordertype199,1<0,0<1)]]></Formula>
</Condition>
</JoinCondition>
</Condition>
</DMLConfig>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=$ordertype1]]></Attributes>
</O>
</Parameter>
</Parameters>
<Content>
<![CDATA[this.options.form.getWidgetByName("house_sche99").setValue(house_sche);
this.options.form.getWidgetByName("org_classify99").setValue(org_classify);
...
this.options.form.getWidgetByName("depttype199").setValue(depttype1);
this.options.form.getWidgetByName("ordertype199").setValue(ordertype1);]]></Content>
</JavaScript>
</JavaScript>
</Listener>
<WidgetName name="body"/>
...
<BoundsAttr x="484" y="73" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="486" y="100" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="489" y="127" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="578" y="76" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="580" y="100" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
<WidgetName name="ordertype199"/>
<WidgetAttr invisible="true" description="">
<PrivilegeControl/>
</WidgetAttr>
<widgetValue>
...
<BoundsAttr x="578" y="127" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<TemplateID TemplateID="0eecd52b-cee7-42b4-9bac-d0be1b259a92"/>
