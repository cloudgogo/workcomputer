...
var args  = urlArgs(),
    ifram = document.getElementById("REPORT1");
if(ifram){
	ifram.src = args._src;
}
...
function urlArgs(){
    ...
    for(var i = 0;i < pairs.length; i++){
        ...
        if(pos == -1) continue;
        var name = pairs[i]A.substring(0, pos);
        var value = pairs[i]A.substring(pos + 1);
...
<TemplateID TemplateID="0827cf42-fbf0-4ab2-93fb-e06d4fcc8a8c"/>
</Form>
