...
<Query>
<![CDATA[SELECT TREE_NODE2,DESCR2,(CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END) CQTNDLZ,
       
       (CASE WHEN create_time ='${date_time}' THEN (CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END) END)-
CASE WHEN (CASE WHEN create_time =TO_CHAR(LAST_DAY(ADD_MONTHS(to_date('${date_time}','yyyy-mm-dd'), -1)), 'yyyy-mm-dd') 
 THEN (CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END)  END) IS NULL THEN 0 END  CQTYDLZ,
       case when
       ((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END))/(((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END))+CQT_DQ) is null then 0
       else
        ((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       ...
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END))+CQT_DQ))
       end
       CQTZDLZL 
...
order by decode(DESCR2,'产业小镇集团(非招商)',1,'产业发展集团(招商)',2,'产业发展集团(非招商)',3),CQTZDLZL  desc]]></Query>
</TableData>
...
FROM ODM_HR_LZTZ WHERE TO_CHAR(LZDATE,'YYYY-MM-dd')<(CASE WHEN '${date_time}'=TO_CHAR(sysdate,'YYYY-MM-DD') THEN '${date_time}' 
...
sum(case when TO_CHAR(LZDATE,'YYYY-MM-dd') BETWEEN substr('${date_time}',0,4)||'-11-01' AND substr('${date_time}',0,4)||'-11-31' then COUNT(ygid) END)  as Eleven,
sum(case when TO_CHAR(LZDATE,'YYYY-MM-dd') BETWEEN substr('${date_time}',0,4)||'-12-01' AND substr('${date_time}',0,4)||'-12-31' then COUNT(ygid) END)  as Twelve
FROM ODM_HR_LZTZ WHERE TO_CHAR(LZDATE,'YYYY-MM-dd')>='${date_time}' 
AND ISCQT='是'
 and TREE_NODE_ID like '%'||'${dwmc}'||'%'
...
<![CDATA[SELECT sum(case when TO_CHAR(DATETIME,'YYYY-MM')='2017-12' then COUNT(ygid) END) 
 as Twelve FROM ODM_HR_YGTZ_HIST WHERE ISCQT='是'
AND YGLEIBIE='正式员工'  and iszhuying='主营'
 AND TREE_NODE_ID LIKE '%${DWMC}%'
GROUP BY DATETIME ]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT T.ZHIJI,T.RENSHU,RATIO_TO_REPORT(T.renshu) OVER() AS zhanbi
FROM 
(SELECT ZHIJI,COUNT(YGID) RENSHU FROM ODM_HR_LZTZ  WHERE ISCQT='是'
AND TREE_NODE_ID LIKE '%${DWMC}%'
...
ELSE TO_CHAR(TO_DATE('${date_time}','YYYY-MM-DD')+1,'YYYY-MM-DD') END)
GROUP BY ZHIJI) T 
GROUP BY T.ZHIJI,T.RENSHU
ORDER BY T.ZHIJI ASC]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT RATIO_TO_REPORT(renshu) OVER() AS zhanbi,T.LZYUANYIN,T.RENSHU FROM (SELECT CASE WHEN LZYUANYIN IS NULL THEN '未填写'  ELSE LZYUANYIN END LZYUANYIN,COUNT(YGID) RENSHU FROM ODM_HR_LZTZ  WHERE ISCQT='是'
AND TREE_NODE_ID LIKE '%${DWMC}%'
  AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<(CASE WHEN '${date_time}'=TO_CHAR(sysdate,'YYYY-MM-DD') THEN '${date_time}' 
ELSE TO_CHAR(TO_DATE('${date_time}','YYYY-MM-DD')+1,'YYYY-MM-DD') END)
GROUP BY LZYUANYIN) T
GROUP BY T.LZYUANYIN,T.RENSHU
...
select  
  '0-0.5年' AS FENLEI,
  count(case when (0<=(case when T1.ISCQT='是' then SILING end) AND (case when T1.ISCQT='是' then SILING end)<= 0.5) then T1.YGID end) gb1
...
select  
  '0.5-1年' AS FENLEI,
  count(case when (0.5<(case when T1.ISCQT='是' then SILING end) AND (case when T1.ISCQT='是' then SILING end)<=1)  then T1.YGID end) gb2
  FROM ODM_HR_LZTZ T1 LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${DWMC}%'
     AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<='${date_time}'
  ...
  select  
  '1-3年' AS FENLEI,
  count(case when (1<(case when T1.ISCQT='是' then SILING end) AND (case when T1.ISCQT='是' then SILING end)<=3)    then T1.YGID end) gb3
  FROM ODM_HR_LZTZ T1 LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${DWMC}%'
     AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<='${date_time}'
  ...
  select  
  '3-5年' AS FENLEI,
  count(case when (3<(case when T1.ISCQT='是' then SILING end)AND (case when T1.ISCQT='是' then SILING end)<=5)     then T1.YGID end) gb4
  FROM ODM_HR_LZTZ T1 LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${DWMC}%'
      AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<='${date_time}'
  ...
  select  
  '5-10年' AS FENLEI,
  count(case when (5<(case when T1.ISCQT='是' then SILING end)AND (case when T1.ISCQT='是' then SILING end)<=10)    then T1.YGID end) gb5
  FROM ODM_HR_LZTZ T1 LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${DWMC}%'
     AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<(CASE WHEN '${date_time}'=TO_CHAR(sysdate,'YYYY-MM-DD') THEN '${date_time}' 
ELSE TO_CHAR(TO_DATE('${date_time}','YYYY-MM-DD')+1,'YYYY-MM-DD') END)
  ...
  select  
  '10年以上' AS FENLEI,
  count(case when 10<(case when T1.ISCQT='是' then SILING end) then T1.YGID end) gb6
  FROM ODM_HR_LZTZ T1 LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${DWMC}%'
     AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<(CASE WHEN '${date_time}'=TO_CHAR(sysdate,'YYYY-MM-DD') THEN '${date_time}' 
...
<Query>
<![CDATA[SELECT SUM((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END)) CQTNDLZ,
       to_char(100*round(SUM((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END))/(SUM((CASE WHEN CQT_LZ_Q1 IS NULL THEN 0 ELSE CQT_LZ_Q1 END)
       +(CASE WHEN CQT_LZ_Q2 IS NULL THEN 0 ELSE CQT_LZ_Q2 END)
       +(CASE WHEN CQT_LZ_Q3 IS NULL THEN 0 ELSE CQT_LZ_Q3 END)
       +(CASE WHEN CQT_LZ_Q4 IS NULL THEN 0 ELSE CQT_LZ_Q4 END))+SUM(CASE WHEN CQT_DQ IS NULL THEN 0 ELSE CQT_DQ END)),3),'fm9999990.0999') CQTZDLZV,SUM(CQT_NC) CQT_NC,SUM(CQT_DQ) CQT_DQ
...
<TableData name="常青藤保存率" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
GROUP BY HRSTATUS,CQTCDLYEAR))
WHERE HRSTATUS='A'
order by CQTCDLYEAR asc]]></Query>
</TableData>
...
<TableData name="常青藤留存率" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
SELECT A.CQTCDLYEAR,A.RENSHU / (A.RENSHU + NVL(B.RENSHU,0)) AS zhanbi,A.RENSHU  AS ZZRENSHU,B.RENSHU AS LZRENSHU
  FROM A
  LEFT JOIN B
  ON A.CQTCDLYEAR = B.CQTCDLYEAR
  ORDER BY B.CQTCDLYEAR]]></Query>
</TableData>
</TableDataMap>
<Parameters/>
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/HR_QUIT/Management_cqt.frm&op=view]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[Management_cqt.frm]]></O>
</ColumnConfig>
...
<![CDATA[723900,1295400,1143000,1143000,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
...
<C c="1" r="1" cs="5" s="1">
<O>
<![CDATA[1 常青藤离职率监控常青藤离职情况，包含辞职/辞退，不含调动至关联公司]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="0" r="2" s="2">
...
<C c="1" r="2" cs="5" s="3">
<O>
<![CDATA[2 常青藤统计口径：仅统计已经正式入职常青藤，不含实习生，不含非主营]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="1" r="3" cs="5" s="3">
<O>
<![CDATA[3 常青藤离职率 = 常青藤离职人数 /（当期离职常青藤+当前在职常青藤）×100%]]></O>
<PrivilegeControl/>
<Expand/>
</C>
</CellElementList>
...
<BoundsAttr x="0" y="0" width="882" height="135"/>
</Widget>
...
<BoundsAttr x="0" y="1131" width="882" height="135"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<ChartSummaryColumn name="CQTZDLZL" function="com.fr.data.util.function.NoneFunction" customName="常青藤离职率"/>
</MoreNameCDDefinition>
</DefinitionMap>
...
<CategoryName value="DESCR2"/>
<ChartSummaryColumn name="CQTNDLZ" function="com.fr.data.util.function.NoneFunction" customName="离职常青藤人数"/>
</MoreNameCDDefinition>
</DefinitionMap>
</DefinitionMapList>
</CustomDefinition>
...
<BoundsAttr x="0" y="0" width="882" height="430"/>
</Widget>
...
<BoundsAttr x="0" y="98" width="882" height="430"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="706" y="0" width="60" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="526" y="0" width="120" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="190" y="0" width="336" height="21"/>
</Widget>
</InnerWidget>
<BoundsAttr x="190" y="0" width="336" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
var url = FR.cjkEncode("/WebReport/ReportServer?reportlet=HXXF_HR%2FHR_QUIT%2FCQTSeparationRate.cpt&date_time="+date_time1+"&dwmc="+dwmc1+"&format=excel&extype=simple&__filename__="+ res+"_常青藤离职率_"+res1);
//alert(0)
...
<BoundsAttr x="826" y="0" width="56" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="27" width="882" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
...
<BoundsAttr x="766" y="0" width="60" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[0,723900,0,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="截止至 " + "<span style='color:#bf0008; font-weight: bold;'>" + YEAR($date_time) + "年" + MONTH($date_time) + "月" + DAY($date_time) + "日 , " + $mc1 + "</span>" + " 本年度常青藤离职率 " + "<span style='color:#bf0008; font-weight: bold;'>" + B3 + "</span>" + CONCATENATE("<font color=#000000 font-weight: bold;>", " ，累计离职 ", "<font color=#000000 sont-weight: bold;>") + "<span style='color:#bf0008; font-weight: bold;'>" + C3 + "</span>" + CONCATENATE("<font color=#000000 sont-weight: bold;>", " 人，当前常青藤 " + "<span style='color:#bf0008; font-weight: bold;'>" + E3 + "</span>" + "  人。", "<font color=#000000 sont-weight: bold;>")]]></Attributes>
</O>
<PrivilegeControl/>
...
<C c="1" r="2" s="1">
<O t="DSColumn">
<Attributes dsName="lzrs" columnName="CQTZDLZV"/>
<Condition class="com.fr.data.condition.ListCondition"/>
<Complex/>
...
<C c="2" r="2">
<O t="DSColumn">
<Attributes dsName="lzrs" columnName="CQTNDLZ"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Result>
<![CDATA[if(len($$$)=0,0,$$$)]]></Result>
...
<C c="3" r="2">
<O t="DSColumn">
<Attributes dsName="lzrs" columnName="CQT_NC"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Result>
<![CDATA[if(len($$$)=0,0,$$$)]]></Result>
...
<C c="4" r="2">
<O t="DSColumn">
<Attributes dsName="lzrs" columnName="CQT_DQ"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Result>
<![CDATA[if(len($$$)=0,0,$$$)]]></Result>
...
<BoundsAttr x="0" y="0" width="882" height="44"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="54" width="882" height="44"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[722880,722880,1756800,0,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<C c="0" r="4" cs="5" rs="15">
<O t="CC">
<LayoutAttr selectedIndex="3"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="离职原因分布（" + year(now()) + "年离职）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<HtmlLabel customText="function(){ return this.category+this.seriesName+this.value+this.percentage;}" useHtml="false" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
<Background name="ColorBackground" color="-16777216"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="离职职级分布（" + year(now()) + "年离职）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="80" foreground="-13421773"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="离职司龄分布（" + year(now()) + "年离职）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="80" foreground="-13421773"/>
...
<Chart name="图表4" chartClass="com.fr.plugin.chart.vanchart.VanChart">
<Chart class="com.fr.plugin.chart.vanchart.VanChart">
<GI>
<AttrBackground>
<Background name="NullBackground"/>
...
<ChartSummaryColumn name="ZHANBI" function="com.fr.data.util.function.NoneFunction" customName="保存率"/>
</MoreNameCDDefinition>
</DefinitionMap>
<DefinitionMap key="column">
<MoreNameCDDefinition>
...
<CategoryName value="CQTCDLYEAR"/>
<ChartSummaryColumn name="LZRENSHU" function="com.fr.data.util.function.NoneFunction" customName="离职"/>
<ChartSummaryColumn name="ZZRENSHU" function="com.fr.data.util.function.NoneFunction" customName="在职"/>
</MoreNameCDDefinition>
</DefinitionMap>
</DefinitionMapList>
</CustomDefinition>
...
<BoundsAttr x="451" y="0" width="431" height="423"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report2"/>
<WidgetAttr description="">
...
<BoundsAttr x="451" y="708" width="431" height="423"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[864000,0,864000,864000,864000,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[3962400,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<PrivilegeControl/>
<Expand/>
...
<C c="1" r="3" s="2">
<O t="DSColumn">
<Attributes dsName="ds1" columnName="CQTNDLZ"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<C c="1" r="4" s="3">
<O t="DSColumn">
<Attributes dsName="ds1" columnName="CQTZDLZL"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="0" y="0" width="882" height="180"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report1"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="528" width="882" height="180"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
...
<BoundsAttr x="140" y="0" width="50" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<Content>
<![CDATA[/*var url = FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR%2FHR_QUIT%2FManagement_GB.frm"); FR.doHyperlinkByGet({url:url,title:'Management_monitoring',target:'_self',date_time:date_time1,dwmc:dwmc1});  */
...
<BoundsAttr x="90" y="0" width="50" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<BoundsAttr x="0" y="0" width="90" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="646" y="0" width="60" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[720000,720000,1728000,722880,722880,722880,722880,722880,722880,722880,722880,722880,722880,722880,722880,722880,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<Content>
<![CDATA[var url = FR.cjkEncode('/WebReport/ReportServer?reportlet=/HXXF_HR/HR_QUIT/Cader_Leave_1.cpt&dwmc='+dwmc1+'&date_time='+date_time1+'&lei='+lei1+'&temp='+tem+'&YF='+YF)
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D5 = NULL, C5 / (H4 + C5), C5 / (C5 + D5))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D6 = NULL, C6 / (H4  + C6) , C6 / (D6 + C6))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D7 = NULL, C7 / (H4 + C7), C7 / (D7+C7))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D8 = NULL, C8 / (H4 + C8), C8 / (C8+D8))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D9 = NULL, C9 / (H4 + C9), C9 / (C9+D9))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D10 = NULL, C10 / (H4 + C10),C10/(C10+D10))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<![CDATA[条件属性1]]></Name>
<Condition class="com.fr.data.condition.ListCondition"/>
<HighlightAction class="com.fr.report.cell.cellattr.highlight.PresentHighlightAction">
<Present class="com.fr.base.present.FormulaPresent">
<Content>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D11 = NULL, C11 / (H4 + C11), C11 / ((D11 + F11) / 2))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D12 = NULL, C12 / (H4 + C12), C12 / (C12+D12))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D13 = NULL, C13 / (H4 + C13), C13 / (C13+D13))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<10,"-",SUM(C13 + B14))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D14 = NULL, C14 / (H4 + C14), C14 / (C14+D14))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D15 = NULL, C15 / (H4 + C15), C15 / (C15+D15))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D16 = NULL, C16/ (H4 + C16), C16/ (C16+D16))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<BoundsAttr x="0" y="0" width="451" height="423"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report0"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="708" width="451" height="423"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="a0aa1b13-fb6f-435c-b2a4-911d15819650"/>
</Form>
