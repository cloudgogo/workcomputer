...
<![CDATA[2552700,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($MENU, "常用报表工具") < 0, "", "<div class='newTitle'>" + I6 + "" + A5 + "" + C5 + "" + D5 + "" + E5 + "" + F5 + "" + G5 + "" + H5 + "" + I5 + "</div>")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($MENU, "常用报表工具") < 0, "", "<div class='newTitle'>常用报表工具==/WebReport/ReportServer?reportlet=HXXF_HR/ReportTool/Employee.cpt&username=" + username + "&userid=" + userid + "==icon-biaoge" + A5 + "" + C5 + "" + D5 + "" + E5 + "" + F5 + "" + G5 + "" + H5 + "" + I5 + "</div>")]]></Attributes>
</O>
<PrivilegeControl/>
...
"==icon-shengzhi,人员统计表==/WebReport/ReportServer?reportlet=HXXF_HR/ReportTool/Major_business.cpt&username=" + username + "&userid=" + userid +
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($STRTEMENT, "人员统计表") < 0, "", ",人员统计表==/WebReport/ReportServer?reportlet=HXXF_HR/ReportTool/Major_business.cpt&username=" + username + "&userid=" + userid + "==icon-lizhi")]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(StringFind($STRTEMENT, "组织报表") < 0, "", "常用报表工具==/WebReport/ReportServer?reportlet=HXXF_HR/ReportTool/DepartureAccount.cpt&username=" + username + "&userid=" + userid + "==icon-biaoge")]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(A6) <> 0, A6, if(len(C6) <> 0, C6, if(len(D6) <> 0, D6, if(len(E6) <> 0, E6, if(len(F6) <> 0, F6, G6,if(len(H6) <> 0,H6))))))]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<TemplateID TemplateID="d32171bb-329d-48ae-8c64-5640e4d8ed01"/>
</Form>
