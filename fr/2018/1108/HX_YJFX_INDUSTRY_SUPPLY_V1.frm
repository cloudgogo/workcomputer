...
window.parent.FS.tabPane.addItem({title:"产业供地详情",src:"${servletURL}?reportlet=ThreeLevelPage/HX_JYFX_INDUSTRY_SUPPLY_THREEV1.cpt&op=view&is_show="+flag+"&org="+org})
]]></Content>
</JavaScript>
</NameJavaScript>
...
<RichChar styleIndex="4">
<text>
<![CDATA[${=if(or(b11=0,len(b11)=0,e11=0,len(e11)=0),'0',round(e11/b11,2)*100)}]]></text>
</RichChar>
<RichChar styleIndex="1">
<text>
<![CDATA[%]]></text>
...
<TemplateID TemplateID="9545184f-58e5-49c2-9fdd-7a4c02500fe7"/>
