...
<![CDATA[
select * from (
select a.org_id,b.org_type,b.org_name,b.org_sname,a.time_type_id,a.target_value target_value,a.actual_value actual_value,a.finish_rate 
from DM_RES_CHECK_return a inner join dim_org b on a.org_id=b.org_id
where isnew=1 and a.return_type='综合'
) res
...
<Query>
<![CDATA[select result.*,round(result.actual_value,1) roundactual from  (
select res.*,
(select finish_rate from (
select a.org_id,b.org_type,b.org_name,b.org_sname,a.time_type_id,a.target_value target_value,a.actual_value actual_value,a.finish_rate 
from DM_RES_CHECK_return a inner join dim_org b on a.org_id=b.org_id
where isnew=1 and a.return_type='综合'
) res
...
order by nvl(finish_rate,0) desc,nvl(actual_value,0) desc ,nvl(target_value,0) desc
)result
where  rownum<=10
order by /*nvl(finish_rate,0) desc,*/nvl(actual_value,0) desc ,nvl(target_value,0) desc
]]></Query>
...
<Query>
<![CDATA[
 select datetype||'-'||round(sum(amount)over(partition by datetype),1) datetype,org_classify_id||'(亿元)' org_classify_id, WEEK_START,round(amount,1) amount,SUM(amount) Over(partition by WEEK_START) sumamount
  ...
  where rownum <= 24
  order by org_classify_id ,res.WEEK_START
]]></Query>
</TableData>
...
<Query>
<![CDATA[  select sum(f.on_order_fund) on_order_fund, f.back_type_id, f.back_over_id
    from dm_res_check_on_order_fund f
   where f.DATA_DATE =
         (SELECT MAX(DATA_DATE) FROM dm_res_check_on_order_fund)
   group by f.back_type_id, f.back_over_id
]]></Query>
</TableData>
<TableData name="在途资金合计" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[ select round(sum(f.month0+f.month1+f.month2+f.month3+f.month4+f.month5+f.month6+f.month7
    +f.month8+f.month9+f.month10+f.month11+f.month12+f.month13)/100000000,0) value
    from dm_res_check_on_order_fund f]]></Query>
</TableData>
<TableData name="4-2" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[with tab1 as (
select itemtype, type, sum(value) value from (
select itemtype , VALUE ,case itemtype when '按揭' then '按揭' else   TYPE end TYPE from (
    
    select f.itemtype,
           sum(f.month0) / 100000000 VALUE,
           '未到期' TYPE
      from dm_res_check_on_order_fund f
     group by f.itemtype
     UNION ALL
     ...
     UNION ALL
     select f.itemtype,
           sum(f.month2 + f.month3) / 100000000 VALUE,
           '逾期一到三个月' TYPE
      from dm_res_check_on_order_fund f
     group by f.itemtype
     UNION ALL
     select f.itemtype,
           sum(f.month4 + f.month5 + f.month6) / 100000000 VALUE,
           '逾期三到六个月' TYPE
      from dm_res_check_on_order_fund f
     group by f.itemtype
     UNION ALL
     select f.itemtype,
           sum(f.month7 + f.month8 + f.month9 + f.month10 + f.month11 +
                     f.month12 + f.month13) / 100000000
                   VALUE,
                 '逾期六个月以上' TYPE
      from dm_res_check_on_order_fund f
     group by f.itemtype)
     )
     group by itemtype, type
     )

,
 tab2 as (    select itemtype, sum(nvl(value, 0)) value from tab1 group by itemtype )

--select * from tab1
select * from (
 select tab1.itemtype, tab1.type, tab1.value,  
 	case when nvl(tab2.value, 0)=0 then 0
 	else tab1.value/tab2.value end rate 
 from tab1, tab2 
 where tab1.itemtype=tab2.itemtype
 )
 where 1=1
 -- and rate>=0.02
...
<TableData name="4-1" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<![CDATA[
select * from (
select a.org_id,b.org_type,b.org_name,b.org_sname,a.time_type_id,round(a.target_value,0) target_value,round(a.actual_value,0) actual_value,a.finish_rate 
from DM_RES_CHECK_return a inner join dim_org b on a.org_id=b.org_id
where isnew=1 and a.return_type='综合'
) res
where res.org_type='集团'
...
<Attributes>
<![CDATA[=sql("oracle_test","select max(data_date) datadate from DM_RES_CHECK_return",1,1)]]></Attributes>
</O>
</Parameter>
<Parameter>
<Attributes name="periodtype"/>
...
if(len($depttype)=0,"","depttype:"+$depttype+";")]]></Attributes>
</O>
</ColumnConfig>
...
this.options.form.getWidgetByName("depttype99").setValue(depttype);]]></Content>
</JavaScript>
</JavaScript>
</Listener>
...
<BoundsAttr x="322" y="76" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="322" y="43" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="301" y="267" width="180" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[0,0,0,1008000,1008000,1008000,1008000,1008000,1008000,1008000,1008000,1008000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<BoundsAttr x="301" y="267" width="541" height="212"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="report2_t"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Margin top="0" left="0" bottom="0" right="0"/>
...
<BoundsAttr x="9" y="267" width="180" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,1143000,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,0,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[2880000,2743200,2743200,2880000,2880000,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<OneValueCDDefinition valueName="VALUE" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[4-2]]></Name>
...
<LevelColumnNameList>
<LevelColumnName levelName="ITEMTYPE"/>
<LevelColumnName levelName="TYPE"/>
</LevelColumnNameList>
</MultiPie>
</MultiPieValueDefinition>
</ChartDefinition>
...
<C c="2" r="16">
<O t="DSColumn">
<Attributes dsName="4-1" columnName="VALUE"/>
<Complex/>
...
<BoundsAttr x="9" y="267" width="281" height="212"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,647700,723900,1440000,1440000,0,1440000,720000,0,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[720000,2743200,2160000,1981200,1440000,2743200,2160000,1828800,1440000,720000,2592000,2592000,2592000,2743200,2592000,2592000,2743200,2743200,2743200,2592000,2592000,2592000,1008000,288000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<CellGUIAttr>
<ToolTipText>
<![CDATA[按实际回款金额排序，显示前10名]]></ToolTipText>
</CellGUIAttr>
<CellPageAttr/>
<Expand/>
</C>
...
<C c="2" r="3" s="8">
<O t="DSColumn">
<Attributes dsName="1" columnName="TARGET_VALUE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=max(value(&quot;2&quot;, 6)) * 1.2"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<![CDATA[#0%]]></Format>
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=max(value(&quot;2&quot;, 8)) * 1.2"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴2" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<ChartSummaryColumn name="TARGET_VALUE" function="com.fr.data.util.function.NoneFunction" customName="目标(亿元)"/>
<ChartSummaryColumn name="ROUNDACTUAL" function="com.fr.data.util.function.NoneFunction" customName="实际(亿元)"/>
</MoreNameCDDefinition>
</DefinitionMap>
<DefinitionMap key="line">
<MoreNameCDDefinition>
...
<CategoryName value="ORG_SNAME"/>
<ChartSummaryColumn name="FINISH_RATE" function="com.fr.data.util.function.NoneFunction" customName="完成率"/>
<ChartSummaryColumn name="RATEALL" function="com.fr.data.util.function.NoneFunction" customName="集团平均完成率"/>
...
<C c="2" r="4" s="8">
<O t="DSColumn">
<Attributes dsName="1" columnName="ACTUAL_VALUE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="4" r="6" rs="2" s="12">
<O t="DSColumn">
<Attributes dsName="1" columnName="FINISH_RATE"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<BoundsAttr x="9" y="32" width="834" height="225"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[144000,864000,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<BoundsAttr x="9" y="2" width="596" height="25"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="数据截止日期："+sql("oracle_test","SELECT SUBSTR(max(data_date),1,4)||'-'||SUBSTR(max(data_date),5,2)||'-'||SUBSTR(max(data_date),7,2) data_date from  DM_RES_CHECK_RETURN",1,1)]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<BoundsAttr x="616" y="2" width="226" height="27"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="f50663ca-f91f-4da9-bed6-b5f2123e2995"/>
