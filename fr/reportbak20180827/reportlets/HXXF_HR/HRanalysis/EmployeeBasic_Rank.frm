...
<TableData name="基础属性平均职级分布" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
ORDER BY a.ZHINENGXULIE ASC]]></Query>
</TableData>
...
FROM(
SELECT 
to_char((B.RENSHU-A.renshu)/2) AS renshu,
'2' AS FENLEI,
A.ZHIJI
FROM(
SELECT 
...
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
GROUP BY ZHIJI
))B ORDER BY ZHIJI ASC, ((B.RENSHU-A.renshu)/2) ASC)

UNION ALL 

SELECT 
renshu ||'.0'|| round(zhanbi*10000,0)||'1' AS renshu,
'1' AS FENLEI,
ZHIJI
FROM(
SELECT 
...
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
GROUP BY XINGBIE)) ORDER BY ZHIJI ASC

]]></Query>
</TableData>
<TableData name="基础属性各职级性别分布_2" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
AND ZHIJI NOT LIKE '%99%'
) GROUP BY YGFENLEI order by YGFENLEI asc)
UNION ALL 
SELECT 
ZHIJI, 
'常青藤' AS XILIE
...
<TableData name="平均职级分布" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="DWMC"/>
<O>
...
FROM ODM_HR_YGTZ
WHERE 1=1
AND (YGFENLEI='干部' OR YGFENLEI='团队负责人')
${if(len(DWMC)=0,""," and BUMENID in(
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='"+DWMC+"' connect by  PARENT_NODE   =  prior TREE_NODE)")}
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/FHRanalysis/EmployeeBasic_Rank.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[EmployeeBasic_Rank.frm]]></O>
</ColumnConfig>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="职级区间分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<BoundsAttr x="0" y="0" width="940" height="246"/>
</Widget>
...
<BoundsAttr x="0" y="710" width="940" height="246"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="职级分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<HtmlLabel customText="function(){ return  this.category+&quot;，&quot;+this.value.toString().split(&apos;.&apos;)[0]+&apos;人&apos;+&quot;，&quot;+((this.value.toString().split(&apos;.&apos;)[1])/1000).toFixed(2) +&apos;%&apos;;}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
<Background name="ColorBackground" color="-16777216"/>
...
<HtmlLabel customText="function(){ return  this.category+&quot;，&quot;+this.value.toString().split(&apos;.&apos;)[0]+&apos;人&apos;+&quot;，&quot;+((this.value.toString().split(&apos;.&apos;)[1])/1000).toFixed(1) +&apos;%&apos;;}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
</labelDetail>
</AttrLabel>
</Attr>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-10092544"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-6750208"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-3407872"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<BoundsAttr x="471" y="0" width="469" height="710"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<VanChartColumnPlotAttr seriesOverlapPercent="20.0" categoryIntervalPercent="20.0" fixedWidth="true" columnWidth="36" filledWithImage="false" isBar="false"/>
</Plot>
<ChartDefinition>
<MoreNameCDDefinition>
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
...
<BoundsAttr x="0" y="0" width="471" height="352"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart9"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="358" width="471" height="352"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr class="com.fr.chart.base.AttrBorder">
<AttrBorder>
<Attr lineStyle="1" isRoundBorder="false" roundRadius="8"/>
<newColor borderColor="-1"/>
</AttrBorder>
</Attr>
<Attr class="com.fr.chart.base.AttrAlpha">
...
<CategoryName value="XILIE"/>
<ChartSummaryColumn name="ZHIJI" function="com.fr.data.util.function.NoneFunction" customName="ZHIJI"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="471" height="358"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart6"/>
<WidgetAttr description="">
...
<![CDATA[2880000,288000,720000,288000,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<span style='font-family: 微软雅黑;color: rgb(51, 51, 51);font-size: 17.3333px;fill: rgb(51, 51, 51);'>平均职级</span>"]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico1.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>总体</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + round(B5, 1) + "级</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<NameJavaScript name="CopyOfCopyOfCopyOfCopyOfCopyOf当前表单对象1">
<JavaScript class="com.fr.form.main.FormHyperlink">
<JavaScript class="com.fr.form.main.FormHyperlink">
<Parameters>
<Parameter>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico2.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + round(B6, 1) + "级</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico3.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>非主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + round(B7, 1) + "级</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico4.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>干部</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(b8)==0,"0", round(B8, 1))+ "级</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico6.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>常青藤</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" +if(len(b10)==0,"0", round(B10, 1))+ "级</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<C c="1" r="4">
<O t="DSColumn">
<Attributes dsName="基础属性平均职级分布" columnName="ZHIJI"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="1" r="7">
<O t="DSColumn">
<Attributes dsName="平均职级分布" columnName="ZHIJI"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
<![CDATA[YGFENLEI]]></CNAME>
<Compare op="0">
<O>
<![CDATA[干部]]></O>
</Compare>
...
<BoundsAttr x="0" y="0" width="940" height="108"/>
</Widget>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各职级性别分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="XINGBIE" valueName="ZHANBI" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
...
<BoundsAttr x="0" y="0" width="940" height="175"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart8"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="781" width="940" height="175"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各职级平均工龄分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[基础属性各职级平均工龄分布]]></Name>
</TableData>
<CategoryName value="ZHIJI"/>
<ChartSummaryColumn name="GONGLING" function="com.fr.data.util.function.NoneFunction" customName="平均工龄"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="940" height="171"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="0" y="610" width="940" height="171"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各职级平均司龄分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<BoundsAttr x="0" y="0" width="940" height="168"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="442" width="940" height="168"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各职级平均年龄分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[基础属性职级分布平均年龄]]></Name>
</TableData>
<CategoryName value="ZHIJI"/>
<ChartSummaryColumn name="YEARSOLD" function="com.fr.data.util.function.NoneFunction" customName="平均年龄"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="940" height="169"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="273" width="940" height="169"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart4"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="本科及以上占比（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<labelAttr enable="true"/>
<labelDetail class="com.fr.plugin.chart.base.AttrLabelDetail">
<Attr showLine="false" autoAdjust="true" position="3" isCustom="true"/>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="72"/>
</Attr>
...
<CategoryName value="ZHIJI"/>
<ChartSummaryColumn name="ZHANBI" function="com.fr.data.util.function.NoneFunction" customName="本科及以上占比"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="0" width="940" height="165"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="108" width="940" height="165"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<BoundsAttr x="0" y="0" width="954" height="1000"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="de38cc02-646a-45cc-adde-f126c433ea52"/>
</Form>
