...
<Query>
<![CDATA[WITH W1 AS (
SELECT ORG_ID,HOUSE_SCHE_ID,PRO_QTY,FIN_PRO_QTY,STAND_MIN,ACTR_MIN
FROM DM_RES_TRADE_RULE
WHERE DATA_DATE = (SELECT MAX(DATA_DATE) FROM DM_RES_TRADE_RULE)
ORDER BY ORG_ID,HOUSE_SCHE_ID
),W2 AS (--实际时长总和
SELECT HOUSE_SCHE_ID,SUM(ACTR_MIN) AS SUM_DATE  
  FROM W1 

  JOIN DIM_ORG T1 ON W1.ORG_ID = T1.ORG_ID  ${if(org_classify="全部","","and T1.org_classify='"+org_classify+"'")}
 
 GROUP BY HOUSE_SCHE_ID
 ),W3 AS (
 SELECT HOUSE_SCHE_ID,COUNT(W1.ORG_ID)*30 AS SUM_DAYS
   FROM W1
  ...
  SELECT W2.HOUSE_SCHE_ID,ROUND(W2.SUM_DATE/W3.SUM_DAYS,1) value_s,case when  W2.HOUSE_SCHE_ID=1         THEN -2
  WHEN W2.HOUSE_SCHE_ID=5 THEN 3
  WHEN W2.HOUSE_SCHE_ID=6 THEN 5
  WHEN W2.HOUSE_SCHE_ID=7 THEN 10
  ELSE 0 END  AS target FROM W2
  LEFT JOIN W3 ON W2.HOUSE_SCHE_ID = W3.HOUSE_SCHE_ID
    order by W2.HOUSE_SCHE_ID desc
]]></Query>
</TableData>
</TableDataMap>
<FormMobileAttr>
...
<O>
<![CDATA[org_classify;cpcs;depttype;ordertype;gzp;]]></O>
</ColumnConfig>
<ColumnConfig name="CANSHU" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($org_classify)=0,"",$org_classify+";")+
if(len($cpcs)=0,"",switch($cpcs,"1","节点平均时长","2","标准工期达标数量","3","区域达标排名")+";")+
if(len($depttype)=0,"",$depttype+";")+
if(len($ordertype)=0,"",$ordertype+";")+
if(len($gzp)=0,"",switch($gzp,"1","已挂牌未摘牌","0","计划挂牌")+";")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="CANSHUMINGYUCANSHU" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($org_classify)=0,"","org_classify:"+$org_classify+";")+
if(len($cpcs)=0,"","cpcs:"+switch($cpcs,"1","节点平均时长","2","标准工期达标数量","3","区域达标排名")+";")+
if(len($depttype)=0,"","depttype:"+$depttype+";")+
if(len($ordertype)=0,"","ordertype:"+$ordertype+";")+
if(len($gzp)=0,"","gzp:"+switch($gzp,"1","已挂牌未摘牌","0","计划挂牌")+";")]]></Attributes>
</O>
</ColumnConfig>
...
if(len($cpcs)=0,"","cpcs:"+switch($cpcs,"1","节点平均时长","2","标准工期达标数量","3","区域达标排名")+";")+
if(len($depttype)=0,"","depttype:"+$depttype+";")+
if(len($ordertype)=0,"","pm:"+$ordertype+";")+
if(len($gzp)=0,"","gzp:"+switch($gzp,"1","已挂牌未摘牌","0","计划挂牌")+";")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="TIME" isKey="false" skipUnmodified="false">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($chaolj)=0,"",if($chaolj=$chaolj99,"",$chaolj+":"+switch($chaolj,"操盘纪律","HX_RESIDENCE/HX_RES_TRADER.frm","风险房源","HX_RESIDENCE/HX_RES_RISK.frm","挂牌土地","HX_RESIDENCE/HX_RES_LISTED_LAND.frm","盘点信息","HX_RESIDENCE/HX_RES_GROUD.frm")))]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
<Formula>
<![CDATA[if($gzp=$gzp99,1<0,0<1)]]></Formula>
</Condition>
</JoinCondition>
...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[if($cpcs=$cpcs99,1<0,0<1)]]></Formula>
</Condition>
</JoinCondition>
<JoinCondition join="1">
<Condition class="com.fr.data.condition.FormulaCondition">
...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[if($org_classify=$org_classify99,1<0,0<1)]]></Formula>
</Condition>
</JoinCondition>
</Condition>
</DMLConfig>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=$org_classify]]></Attributes>
</O>
</Parameter>
</Parameters>
<Content>
<![CDATA[this.options.form.getWidgetByName("org_classify99").setValue(org_classify);
this.options.form.getWidgetByName("cpcs99").setValue(cpcs);
...
this.options.form.getWidgetByName("gzp99").setValue(gzp);
...
<WidgetName name="org_classify99"/>
...
<BoundsAttr x="353" y="371" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="351" y="316" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
<WidgetName name="gzp99"/>
<WidgetAttr invisible="true" description="">
<PrivilegeControl/>
</WidgetAttr>
<widgetValue>
...
<BoundsAttr x="350" y="299" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="352" y="274" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="352" y="248" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
<WidgetName name="cpcs99"/>
<WidgetAttr invisible="true" description="">
<PrivilegeControl/>
</WidgetAttr>
<widgetValue>
...
<BoundsAttr x="354" y="224" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<AxisRange minValue="=if(or(max(ds4.group(value_s))=0, len(max(ds4.group(value_s)))=0 ), 0, max(ds4.group(value_s))*1.2 )*-1/4" maxValue="=if(or(max(ds4.group(value_s))=0, len(max(ds4.group(value_s)))=0 ), 0, max(ds4.group(value_s))*1.2 )"/>
...
<CategoryName value="HOUSE_SCHE_ID"/>
...
<VanChartColumnPlotAttr seriesOverlapPercent="0.0" categoryIntervalPercent="20.0" fixedWidth="true" columnWidth="15" filledWithImage="false" isBar="false"/>
</VanChartPlot>
<VanChartPlot class="com.fr.plugin.chart.line.VanChartLinePlot">
<VanChartPlotVersion version="20170715"/>
<GI>
...
<BoundsAttr x="16" y="48" width="198" height="48"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<TemplateID TemplateID="cc21afa4-df70-4552-b91f-301a0ade4540"/>
