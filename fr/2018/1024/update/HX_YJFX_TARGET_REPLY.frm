...
SELECT  caliber||'-' AS caliber,zhibiao||'-'||decode(val,0,'',val) AS zhibao,decode(index_name,'配套','城市及其他类',index_name) as index_name1, ORDER_CALIBER,
...
<Attributes>
<![CDATA[=if(len($info)=0,"",
$info+":"+"/ThreeLevelPage/OPE_FIN_INDEX_APPROVAL_THREE.cpt")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
window.parent.FS.tabPane.addItem({title:title,src:"${servletURL}?reportlet=ThreeLevelPage%2FOPE_FIN_INDEX_APPROVAL_THREE.cpt&op=view&is_show="+isshow+"&org="+org})
]]></Content>
</JavaScript>
</NameJavaScript>
...
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,5328000,1485900,4032000,2592000,2592000,2592000,2592000,720000,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[720000,571500,864000,864000,2160000,2160000,2160000,2160000,864000,864000,723900,2160000,2160000,864000,864000,864000,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<TemplateID TemplateID="c0d9d160-15d3-403e-91d5-908c701be577"/>
