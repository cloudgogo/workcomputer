...
index1 as (
  ...
  from dim_index i
 where i.index_id in ('81a24bfbfa9a45ebaf35ed9466b0e553',
                      'd3b49d2f94bc4fa8896ba93d9a4abec6')
  )
...
select code,
  ...
  from (select * from datetable d left join org o on 1 = 1 left join index1 on 1=1) dim
  left join dm_mcl_acct a
    on dim.code = a.period_type_id
   and dim.org_id = a.org_id
   and dim.index_id=a.index_id
   and a.index_id in ( '81a24bfbfa9a45ebaf35ed9466b0e553', 'd3b49d2f94bc4fa8896ba93d9a4abec6' )
...
<Attributes name="org"/>
<O>
<![CDATA[823744BA-BC95-4839-8379-A7D16AA20F1B]]></O>
</Parameter>
<Parameter>
<Attributes name="periodtype"/>
<O>
...
select index_name, c.index_id,
	  --decode(c.index_id, '81a24bfbfa9a45ebaf35ed9466b0e553', round(nvl(a.target_value, 0)),  round(nvl(a.target_value, 1)) )  target_value,
	  round(nvl(a.target_value, 0), 1)   target_value,

	   --decode(c.index_id, '81a24bfbfa9a45ebaf35ed9466b0e553', round(nvl(a.actual_value, 0)),   round(nvl(a.actual_value, 1)) )  actual_value,
       ...
       nvl(forecate_value, 0) forecate_value,
       case
         when nvl(a.target_value, 0) = 0 then
          0
         else
 ...
 where 1 = 1
   ...
   and c.index_id in ( '81a24bfbfa9a45ebaf35ed9466b0e553', 'f1a3f1d86fe54ca0a3b7772fa55bb86f',
   '83f0488d1f7e45cf81f4875f9067438b',
...
<TableData name="ZZQD_KJ" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="org"/>
<O>
...
<Query>
<![CDATA[WITH date1 as(
select max(data_date) date1 from dm_mcl_acct where rownum = 1
),
DIM_DATEKJ AS (
SELECT 
...
SELECT 
    ...
    case when f.zhibiao='目标'  then 
      ...
      else round(sum(nvl(e.ACTUAL_VALUE, 0)) ,1) end value
...
<TableData name="ZZQD_KJLV" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="org"/>
<O>
...
DIM_ORF_HX AS
 (SELECT ORG_ID, ORG_NAME FROM DIM_ORG where org_id = '${org}' ) --产业新城维度
...
org as
 (select org_id, org_shortname org_name, o.org_num, o.isshow
    from dim_org_jxjl o
   where 1 = 1
     and o.isshow = 1
     and parentid =
...
select o.org_id, o.org_name, i.index_id, i.index_name, a.actual_value
 ...
 where a.org_id = o.org_id
   ...
   and a.index_id = '81a24bfbfa9a45ebaf35ed9466b0e553'
   and a.period_type_id = case '${periodtype}'
         when '当年' then
          substr(date1.date1, 1, 4)
         when '当季' then
...
<Attributes>
<![CDATA[=if(len($info)=0,"",
$info+":"+"/ThreeLevelPage/OPE_FIN_RESIDENTIAL_TAKE_THREE.cpt")]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
<![CDATA[190500,722880,722880,722880,722880,722880,722880,722880,722880,722880,722880,723900]]></RowHeight>
...
<Attr4VanChart floating="true" x="70.0" y="0.0" limitSize="false" maxHeight="15.0" isHighlight="true"/>
</Legend4VanChart>
<DataSheet>
<GI>
<AttrBackground>
...
<BoundsAttr x="322" y="26" width="298" height="170"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="758" y="27" width="86" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Content>
<![CDATA[if(periodtype=="当季"){
	var isshow="Y";
	var title="住宅取地季度预估详情";
}else{
	var isshow="N";
	var title="住宅取地详情";
}

window.parent.FS.tabPane.addItem({title:title,src:"${servletURL}?reportlet=ThreeLevelPage%2FHX_YJFX_RESIDENTIAL_TAKE_THREE.cpt&op=view&is_show="+isshow+"&org="+org})
]]></Content>
</JavaScript>
</NameJavaScript>
...
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,5760000,2880000,2880000,2880000,2880000,2880000,720000,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[876300,1008000,1008000,1008000,1008000,1008000,1008000,1008000,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,2592000,2592000,720000,2592000,2592000,720000,2880000,2880000,2880000,2880000,432000,2160000,2160000,2160000,2160000,2160000,2160000,2160000,2160000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=IF(or(MAX(ZZQD_KJ.GROUP(value)) = 0, len(MAX(ZZQD_KJ.GROUP(value))) = 0), 0, MAX(ZZQD_KJ.GROUP(value)) * 1.3)"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<OneValueCDDefinition seriesName="INDEX_NAME" valueName="VALUE" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ZZQD_KJ]]></Name>
...
<HtmlLabel customText="function(){ return this.seriesName+&apos;&lt;br/&gt;&apos;+this.value+&apos;亩&apos;+FR.contentFormat(this.percentage,&quot;#%&quot;);}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
</labelDetail>
</AttrLabel>
</Attr>
...
<TemplateID TemplateID="41235a23-f61a-4703-8900-9aacd9e1e9a1"/>
