...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[len($v_tree1_id)<>0]]></Formula>
</Condition>
</JoinCondition>
<JoinCondition join="0">
<Condition class="com.fr.data.condition.ListCondition">
...
if((role != "" || user != "") && (mk != "" || org != "")) {
    ...
    FR.Msg.toast('填报失败,角色，模块，组织都不能为空，请检查后提交!');
...
<Content>
<![CDATA[//获得数节点值
var val=this.options.form.getWidgetByName("textEditor0").getValue();
...
//this.options.form.getWidgetByName("tree1").setValue(val);
...
window.parent.FS.tabPane.addItem({title:"数据权限v2.0",src:"${servletURL}?formlet=cpt_test%2FHX_DATA_AUT_0905.frm&p_role="+r1}) 
]]></Content>
</JavaScript>
</Listener>
...
<Content>
<![CDATA[
var sqlr11="select rolename  from FR_T_CUSTOMROLE_V where id='"+val2+"' ";
var val = FR.remoteEvaluate('sql("oracle_test","' + sqlr11 + '", 1)');
this.options.form.getWidgetByName("tree1").setValue(val);
this.options.form.getWidgetByName("textEditor0").setValue(val);
...
<BoundsAttr x="158" y="0" width="64" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=sql("oracle_test", " select rolename  from FR_T_CUSTOMROLE_V where id='"+$p_role+"' ", 1)]]></Attributes>
</O>
</widgetValue>
</InnerWidget>
<BoundsAttr x="0" y="0" width="158" height="21"/>
</Widget>
</InnerWidget>
<BoundsAttr x="0" y="0" width="158" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.TreeEditor">
<Listener event="click">
...
window.parent.FS.tabPane.addItem({title:"数据权限v2.0",src:"${servletURL}?formlet=cpt_test%2FHX_DATA_AUT_0905.frm&p_role="+r1+"&p_type=role"}) 
]]></Content>
</JavaScript>
</Listener>
<Listener event="afterinit">
...
<Content>
<![CDATA[//获取role文本框并赋值(id name)
var v_tree1_id =this.options.form.getWidgetByName("v_tree1_id"); 
v_tree1_id.setValue(val);
var v_tree1_n =this.options.form.getWidgetByName("v_tree1_n"); 
var sqlr1="select rolename  from FR_T_CUSTOMROLE_V where id='"+val+"' ";
var r1 = FR.remoteEvaluate('sql("oracle_test","' + sqlr1 + '", 1)');
v_tree1_n.setValue(r1);
...
//根据角色获取模块id
var sql21 = "select reportid from dm_hx_data_aut where roleid='" + val + "'";
var rs21 = FR.remoteEvaluate('sql("oracle_test","' + sql21 + '", 1)');
//alert("rs21====="+rs21);
var reg=new RegExp(",","g");
var s = "'"+rs21.replace(reg,"','")+"'";
...
//----------------------组织------------------------
//根据角色获取组织code
var sql31="select orgid from dm_hx_data_aut where roleid='" + val + "'";
var rs31 = FR.remoteEvaluate('sql("oracle_test","' + sql31 + '", 1)');
//alert(rs31);
...
<BoundsAttr x="0" y="24" width="222" height="369"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="512c14d8-f29c-45fb-a2a1-2055ca370cc3"/>
