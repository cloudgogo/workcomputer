...
<![CDATA[select FENLEI ,
XILIE,
REPLACE(TO_CHAR(ROUND(SILING,1),'9990.0'),' ','') AS SILING
from (
SELECT 
'主营/非主营' AS FENLEI,
XILIE,
 SILING 
FROM(
SELECT CASE WHEN SILING IS NULL
            THEN 0
            ELSE SILING
        END AS SILING,
        XILIE
...
(
SELECT
CASE WHEN AVG(SILING) IS NULL
     THEN 0
     ELSE AVG(SILING)
     END AS SILING, 
     CASE WHEN YGFENLEI IS NULL 
     THEN '干部'
     ELSE YGFENLEI
     END AS YGFENLEI
FROM ODM_HR_YGTZ
...
<Query>
<![CDATA[SELECT
a.RENSHU||'.0' ||round((a.RENSHU/b.RENSHU)*1000,0) AS  RENSHU,
a.FENLEI
FROM(
SELECT 
...
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='10048109174' connect by  PARENT_NODE   =  prior TREE_NODE)
AND YGFENLEI = '干部'
AND ZHIJI NOT LIKE '%99%'
GROUP BY YGFENLEI]]></Query>
</TableData>
</TableDataMap>
<Parameters/>
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/HRanalysis/EmployeeBasic_OurAge.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[EmployeeBasic_OurAge.frm]]></O>
</ColumnConfig>
...
<![CDATA[2880000,288000,720000,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,2743200,432000,2743200,432000,2743200,432000,2743200,432000,2743200,432000,2743200,432000,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<span style='font-family: 微软雅黑;color: rgb(51, 51, 51);font-size: 17.3333px;fill: rgb(51, 51, 51);'>平均司龄</span>"]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico1.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>总体</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B4)==0,"0",if(B4<1,CONCATENATE("0",B4),B4)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
...
<Features/>
<realateName realateValue="chart12"/>
<linkType type="0"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<![CDATA[_blank]]></TargetFrame>
<Features/>
<realateName realateValue="chart13"/>
<linkType type="0"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<![CDATA[_blank]]></TargetFrame>
<Features/>
<realateName realateValue="chart14"/>
<linkType type="0"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<![CDATA[_blank]]></TargetFrame>
<Features/>
<realateName realateValue="report0_c"/>
<linkType type="1"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico2.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B5)==0,"0",if(B5<1,CONCATENATE("0",B5),B5)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico3.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>非主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(b7)==0,"0",if(B6<1,CONCATENATE("0",B6),B6)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico4.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>干部</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B7)==0,"0",if(B7<1,CONCATENATE("0",B7),B7)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico5.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>团队负责人</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B8)==0,"0",if(B8<1,CONCATENATE("0",B8),B8))+ "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 40%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico6.png'/></div><div style='width: 55%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>常青藤</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B9)==0,"0",if(B9<1,CONCATENATE("0",B9),B9)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<C c="1" r="3">
<O t="DSColumn">
<Attributes dsName="整体平均司龄分布" columnName="SILING"/>
...
<BoundsAttr x="0" y="0" width="940" height="94"/>
</Widget>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="司龄区间性别分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<ColorList>
<OColor colvalue="-5197648"/>
<OColor colvalue="-2228216"/>
...
<BoundsAttr x="0" y="0" width="940" height="364"/>
</Widget>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各职级性别分布（"+if(len($FENLEI)=0,"整体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104"/>
...
<BoundsAttr x="0" y="442" width="940" height="364"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart12"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Margin top="0" left="0" bottom="0" right="0"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="司龄区间分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104"/>
...
<BoundsAttr x="0" y="0" width="940" height="348"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart8"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="94" width="940" height="348"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart14"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Margin top="0" left="0" bottom="0" right="0"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="司龄区间平均职级分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<BoundsAttr x="0" y="0" width="940" height="350"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="0" y="806" width="940" height="350"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
<Widget widgetName="report0_c"/>
<Widget widgetName="chart12"/>
<Widget widgetName="chart13"/>
<Widget widgetName="chart14"/>
</MobileWidgetList>
<WidgetZoomAttr compState="0"/>
<AppRelayout appRelayout="true"/>
<Size width="940" height="1156"/>
...
<TemplateID TemplateID="d2501fc2-bb98-4330-a21f-3e453b1b0d0d"/>
</Form>
