...
<Query>
<![CDATA[select ORG_SNAME,AREA_LAND,HANG_DATE,HANG_TYPE FROM DM_RES_HANG a
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[0,1008000,1008000,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[720000,2743200,2743200,0,7658100,0,0,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<Attributes>
<![CDATA[=if(len(D2) = 0, "","计划") + LEFT(D2, 4) + if(len(D2) = 0, "", "年") + MID(D2, 5, 2) + IF(LEN(D2) = 0, "", "月") + MID(D2, 7, 2) + if(len(D2) = 0, "", "日摘牌")]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<marquee id='affiche' style='text-align:center;' behavior='scroll' behavior='scroll' bgcolor='#ffffff' direction='up' height='250' width='400' hspace='0' vspace='2' loop='-1' scrollamount='10' scrolldelay='100' onMouseOut='this.start()' onMouseOver='this.stop()'>" + REPLACE(B2 + "             " + C2 + "亩             " + E2, ",", "<br /><br />") + "</marquee>"]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(LEN(D3) = 0, "","计划") + LEFT(D3, 4) + if(len(D3) = 0, "", "年") + MID(D3, 5, 2) + IF(LEN(D3) = 0, "", "月") + MID(D3, 7, 2) + if(len(D3) = 0, "", "日挂牌")]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<BoundsAttr x="527" y="86" width="315" height="152"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Parameters/>
<Content>
<![CDATA[window.parent.FS.tabPane.addItem({title:"风险房源",src:"${servletURL}?formlet=RESIDENCE/view/RISK_RESOURCES.frm"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<Expand/>
...
<Parameters/>
<Content>
<![CDATA[window.parent.FS.tabPane.addItem({title:"挂牌土地",src:"${servletURL}?formlet=RESIDENCE/view/LISTED_LAND.frm"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<Expand/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[533400,1942560,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="摘牌-土方及桩基<br/>进场"]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="摘牌-规划方案<br/>政府审批"]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<Parameters/>
<Content>
<![CDATA[window.parent.FS.tabPane.addItem({title:"操盘纪律",src:"${servletURL}?formlet=RESIDENCE/view/TRADER_DISCIPLINE.frm"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<Expand/>
...
<Parameters/>
<Content>
<![CDATA[window.parent.FS.tabPane.addItem({title:"盘点信息",src:"${servletURL}?formlet=RESIDENCE/view/information/GROUD.frm"})]]></Content>
</JavaScript>
</NameJavaScript>
</NameJavaScriptGroup>
<Expand/>
...
<TemplateID TemplateID="c7f94b74-482b-45f7-9abe-8e7b925a8f6c"/>
