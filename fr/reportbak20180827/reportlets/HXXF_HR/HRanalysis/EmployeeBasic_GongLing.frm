...
<TableDataMap>
<TableData name="整体工龄分布" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
FROM(
SELECT '整体' AS FENLEI,
       ROUND(AVG(ABS(TO_DATE(TO_CHAR(SYSDATE, 'YYYY-MM-DD'),'YYYY-MM-DD') 
	           - 
             TRUNC(TO_DATE(TO_CHAR(YGTZ.CJGZDATE, 'YYYY-MM-DD'),'YYYY-MM-DD'))) / 365) , 
             1)  AS AVGGL
  FROM ODM_HR_YGTZ YGTZ
 WHERE 1=1
   AND CJGZDATE IS NOT NULL
...
(ABS(TO_DATE(TO_CHAR(SYSDATE, 'YYYY-MM-DD'),'YYYY-MM-DD') 
	           - 
             TRUNC(TO_DATE(TO_CHAR(CJGZDATE, 'YYYY-MM-DD'),'YYYY-MM-DD'))) / 365) AS GONGLING
FROM ODM_HR_YGTZ
WHERE 1=1
${SWITCH(FENLEI,'',"",'总体',"",'主营',"AND ISZHUYING  ='主营'",'非主营',"AND ISZHUYING  !='主营'",'团队负责人',"AND YGFENLEI LIKE '团队负责人'",'干部',"AND YGFENLEI LIKE '干部'",'常青藤',"AND ISCQT= '是'
AND ISZHUYING  ='主营'")}
...
<Query>
<![CDATA[SELECT '整体' AS FENLEI,
      AVG(substr(ZHIJI,0,2))  AS AVGGL
  FROM ODM_HR_YGTZ YGTZ
 WHERE 1=1
   AND CJGZDATE IS NOT NULL
${if(len(DWMC)=0,""," and BUMENID in(
...
<TableData name="工龄区间分布" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="FENLEI"/>
<O>
...
${SWITCH(FENLEI,'',"",'总体',"",'主营',"AND ISZHUYING  ='主营'",'非主营',"AND ISZHUYING  !='主营'",'团队负责人',"AND YGFENLEI LIKE '团队负责人'",'干部',"AND YGFENLEI LIKE '干部'",'常青藤',"AND ISCQT= '是'
AND ISZHUYING  ='主营'")}
   ${if(len(DWMC)=0,"and 1=1"," and TREE_NODE_ID LIKE '%"+DWMC+",%'")})b]]></Query>
</TableData>
<TableData name="工龄区间平均职级" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
<Attributes name="FENLEI"/>
<O>
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/HRanalysis/EmployeeBasic_GongLing.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[EmployeeBasic_GongLing.frm]]></O>
</ColumnConfig>
...
<WidgetName name="6edfba34-f4d3-4004-a062-3186d396c118"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Margin top="0" left="0" bottom="0" right="0"/>
...
<WidgetName name="ef50e0a8-19c7-4fa9-840e-9c8b98622d59"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
...
<![CDATA[720000,144000,720000,432000,720000,432000,720000,432000,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[432000,2743200,432000,2743200,720000,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<span style='font-family: 微软雅黑;color: rgb(51, 51, 51);font-size: 17.3333px;fill: rgb(51, 51, 51);'>平均工龄</span>"]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 45%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico1.png'/></div><div style='width: 50%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>总体</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B9)==0,"0", round(B9, 1)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 45%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico4.png'/></div><div style='width: 50%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>干部</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B12)==0,"0", round(B12, 1)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 45%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico2.png'/></div><div style='width: 50%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B10)==0,"0", round(B10, 1)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<div style='width: 45%;float: left;text-align: right;border-right: 1px solid #e5e5e5;'><img style='height: 39px;margin-right: 10px;'src='/WebReport/pageperfor/ico3.png'/></div><div style='width: 50%;float: right;text-align: left;'><div><span style='font-size: 12px;color: black;'>非主营</span></br><span style='font-size: 16px;color: black;font-weight:bold;'>" + if(len(B11)==0,"0", round(B11, 1)) + "年</span></div></div>"]]></Attributes>
</O>
<PrivilegeControl/>
<NameJavaScriptGroup>
<NameJavaScript name="当前表单对象1">
...
<C c="1" r="8">
<O t="DSColumn">
<Attributes dsName="整体工龄分布" columnName="AVGGL"/>
...
<BoundsAttr x="0" y="0" width="384" height="293"/>
</Widget>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="工龄区间分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<BoundsAttr x="384" y="0" width="572" height="293"/>
</Widget>
...
<BoundsAttr x="0" y="0" width="956" height="425"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<BoundsAttr x="0" y="293" width="956" height="425"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各工龄区间平均职级（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<BoundsAttr x="0" y="0" width="956" height="238"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart4"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="718" width="956" height="238"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="6824cad2-9274-42c8-8b97-1773141e6e47"/>
</Form>
