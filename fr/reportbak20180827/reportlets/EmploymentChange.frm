...
FROM ODM_HR_DW
  start with TREE_NODE ='HX_HEAD' connect by  PARENT_NODE   =  prior TREE_NODE)
       ...
       UNION ALL
SELECT '2019预测值' AS NIANDU,
       null as ZYNUM,
       null as NZYNUM,
       null as TOTALNUM,
       19833 as ZYNUM1,
       4653 as NZYNUM1, --3653
       23486 as TOTALNUM1       
...
(
 ...
 /*UNION ALL
	 ...
	 SELECT  DISTINCT TREE_NODE_NUM,
	 SUBSTR(TDATE,1,4)||'. '|| SUBSTR(TDATE,5,2) AS TDATE,
	 TREE_NODE,PARENT_NODE,DESCR,TREE_NODES,PARENT_NAME,HZS FROM TT2
	 )
...
T1.PARENT_NAME  ,
${if(OR(len(FENLEI)==0,FENLEI=2) ,"ZRS",if(FENLEI=1,"ZY","FZY"))} AS ZRS    
FROM ODM_HR_UNITS_COUNT_20180313 T1
LEFT JOIN ODM_HR_DW T2 ON T1.TREE_NODE=T2.TREE_NODE
WHERE T1.PARENT_NODE='HX_HEAD'
order by T1.TDATE,T2.TREE_NODE_NUM
),
...
<ChartSummaryColumn name="ZYNUM1" function="com.fr.data.util.function.NoneFunction" customName="主营预测"/>
<ChartSummaryColumn name="NZYNUM1" function="com.fr.data.util.function.NoneFunction" customName="非主营预测"/>
<ChartSummaryColumn name="TOTALNUM1" function="com.fr.data.util.function.NoneFunction" customName="总人数预测"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<ColumnWidth defaultValue="2743200">
<![CDATA[720000,3771900,2160000,2160000,2160000,2160000,2743200,1728000,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<TemplateID TemplateID="61087d8c-52e7-4078-8a83-f13006e5e9fe"/>
</Form>
