...
<Query>
<![CDATA[
SELECT TREE_NODE2,DESCR2,
ZY_ZD_SSLZ, 
case when ZY_ND_ZDLZ is null  then  0  else  ZY_ND_ZDLZ end ZYNDZDLZ,
case  when ZY_ND_ZDLZ is null or ZY_ND_ZDLZ=0 then 0
else
round(ZY_ND_ZDLZ/(((case when ZY_NC is null then 0 else  ZY_NC end)+(case when ZY_DQ is null then 0 else  ZY_DQ end))/2),3)  end  ZYZDLZL ,
(CASE WHEN create_time ='${date_time}' THEN ZY_ND_ZDLZ END)-CASE WHEN (CASE WHEN create_time =TO_CHAR(LAST_DAY(ADD_MONTHS(to_date('${date_time}','yyyy-mm-dd'), -1)), 'yyyy-mm-dd') 
 THEN ZY_ND_ZDLZ  END) IS NULL THEN 0 END  ZYZDLZ_MONTH
...
--产业
${if(dwmc='10004100730'," and TREE_NODE2 not in ('1000410073Z0','1000410073F0' ) ","")}
--如果HX_HEAD 查询全部 ，股份总部*/
and parent_node ='${dwmc}'
order by decode(DESCR2,'产业小镇集团(非招商)',1,'产业发展集团(招商)',2,'产业发展集团(非招商)',3),ZYZDLZL  desc]]></Query>
</TableData>
...
FROM ODM_HR_LZTZ WHERE TO_CHAR(LZDATE,'YYYY-MM-dd')<'${date_time}' AND ISZHUYING='主营' AND LZLEIXING = '辞职'
 AND (LZYUANYIN <> '调动到其他关联公司' OR LZYUANYIN IS NULL)
...
FROM ODM_HR_YGTZ_HIST WHERE ISZHUYING='主营'
 and TREE_NODE_ID like '%'||'${dwmc}'||'%'
...
<![CDATA[SELECT sum(case when TO_CHAR(DATETIME,'YYYY-MM')='2017-12' then COUNT(ygid) END) 
 as Twelve FROM ODM_HR_YGTZ_HIST WHERE ISZHUYING='主营'
  AND TREE_NODE_ID like '%'||'${dwmc}'||'%'
GROUP BY DATETIME 
]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT ZHIJI,COUNT(YGID) RENSHU FROM ODM_HR_LZTZ  WHERE ISZHUYING='主营'
AND TREE_NODE_ID LIKE '%${DWMC}%'
...
<Query>
<![CDATA[SELECT CASE WHEN LZYUANYIN IS NULL THEN '未填写原因'  ELSE LZYUANYIN END LZYUANYIN,COUNT(YGID) RENSHU FROM ODM_HR_LZTZ  WHERE ISZHUYING='主营'
AND LZLEIXING = '辞职'
                   AND (LZYUANYIN <> '调动到其他关联公司' OR LZYUANYIN IS NULL)
AND TREE_NODE_ID LIKE '%${DWMC}%'
  AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
...
SELECT t1.ygid,T2.SILING FROM ODM_HR_LZTZ T1
       LEFT JOIN ODM_HR_YGTZ_NA T2 ON T1.YGID=T2.YGID
  AND T1.TREE_NODE_ID LIKE '%${dwmc}%'
  WHERE  LZLEIXING = '辞职'
                    AND T1.ISZHUYING='主营'
                   AND (T1.LZYUANYIN <> '调动到其他关联公司' OR T1.LZYUANYIN IS NULL)
                    AND TO_CHAR(LZDATE,'YYYY') =  SUBSTR('${date_time}', 0, 4)
  and TO_CHAR(LZDATE,'YYYY-MM-DD')<='${date_time}'
)
SELECT  '0-0.5年' AS FENLEI,  
count(case when (0<= T1.SILING  AND T1.SILING <= 0.5) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
union all 
SELECT  '0.5-1年' AS FENLEI,  
count(case when (0.5< T1.SILING  AND T1.SILING <=1) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
union all 
SELECT  '1-3年' AS FENLEI,  
count(case when (1< T1.SILING  AND T1.SILING <=3) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
union all 
SELECT  '3-5年' AS FENLEI,  
count(case when (3< T1.SILING  AND T1.SILING <=5) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
union all 
SELECT  '5-10年' AS FENLEI,  
count(case when (5< T1.SILING  AND T1.SILING <=10) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
union all 
SELECT  '10年以上' AS FENLEI,  
count(case when (10< T1.SILING) then T1.YGID end) gb1
FROM ODM_HR_LZTZ1 T1
]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT SUM(ZY_ND_ZDLZ) NDZDLZ, --主营年度离职
...
SUM(case when ZY_NC is null then 0 else ZY_NC END) ZY_NC,SUM(ZY_DQ) ZY_DQ
FROM ODM_HR_YGLZRATE WHERE 1=1 and create_time ='${date_time}'
${if(len(dwmc)=0,"","and TREE_NODE2='"+dwmc+"'")}]]></Query>
</TableData>
...
<TableData name="主动离职人数" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<BoundsAttr x="720" y="0" width="63" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<![CDATA[648000,864000,864000,864000,576000,723900,723900,723900,723900,723900,723900]]></RowHeight>
...
<C c="1" r="1" cs="5" s="1">
<O>
<![CDATA[1 主动离职率仅监控主营员工辞职情况，不含辞退员工，不含非主营员工，不含调动至关联公司]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="6" r="1" s="2">
...
<C c="1" r="2" cs="5" s="1">
<O>
<![CDATA[2 主动离职率（主营）= 2018年主动离职主营员工 /（（年初主营+当前主营）/2）×100%]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="6" r="2" s="2">
...
<C c="1" r="3" cs="6" s="3">
<O>
<![CDATA[3 招商定义：产业发展集团总部的干部及职能中心内职能序列员工属于非招商，其余为招商人员；产业小镇集团招商员工为“招商序列”内所有员工，其余为非招商人员]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="1" r="4">
...
<BoundsAttr x="0" y="0" width="900" height="98"/>
</Widget>
...
<C c="1" r="1" cs="5" s="1">
<O>
<![CDATA[ 1 主动离职率仅监控主营员工辞职情况，不含辞退员工，不含非主营员工]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="6" r="1" s="2">
...
<C c="1" r="3" cs="6" s="3">
<O>
<![CDATA[3 招商定义：产业发展集团：“招商序列”内所有员工及“管理序列”内产业服务公司员工；产业小镇集团招商员工为“招商序列”内所有员工]]></O>
<PrivilegeControl/>
</C>
</CellElementList>
<ReportAttrSet>
...
<BoundsAttr x="0" y="1082" width="900" height="98"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="656" y="0" width="64" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="188" y="0" width="342" height="21"/>
</Widget>
</InnerWidget>
<BoundsAttr x="188" y="0" width="342" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[952500,723900,0,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="截止至 " + "<span style='color:#bf0008; font-weight: bold;'>" + YEAR($date_time) + "年" + MONTH($date_time) + "月" + DAY($date_time) + "日 , " + $MC1 + "</span>" + " 主营员工主动离职率 " + "<span style='color:#bf0008; font-weight: bold;'>" + B3 + "</span>" + CONCATENATE("<font color=#000000 font-weight: bold;>", " ，累计主动离职 ", "<font color=#000000 sont-weight: bold;>") + "<span style='color:#bf0008; font-weight: bold;'>" + C3 + "</span>" + CONCATENATE("<font color=#000000 sont-weight: bold;>", " 人，年初主营 ", "<font color=#000000 sont-weight: bold;>") + "<span style='color:#bf0008; font-weight: bold;'>" + D3 + "</span>" + CONCATENATE("<font color=#000000 sont-weight: bold;>", " 人，当前主营 " + "<span style='color:#bf0008; font-weight: bold;'>" + E3 + "</span>" + " 人。", "<font color=#000000 sont-weight: bold;>")]]></Attributes>
</O>
<PrivilegeControl/>
...
<C c="2" r="2">
<O t="DSColumn">
<Attributes dsName="主动离职人数" columnName="NDZDLZ"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="0" y="0" width="900" height="40"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="68" width="900" height="40"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="24" width="900" height="44"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,0,723900,864000,0,723900,723900,722880,864000,1028700,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[5676900,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<PrivilegeControl/>
<Expand/>
...
<C c="1" r="3" s="4">
<O t="DSColumn">
<Attributes dsName="ds1" columnName="ZYZDLZL"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(b7)=0,'-',ROUND(A5*B7,3))]]></Attributes>
</O>
<PrivilegeControl/>
<Expand/>
</C>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=sql("HXXF_HR", "select tree_node ,descr,z_y  from ODM_HR_LZRATE where year='2018' AND tree_node='" + B2 + "' ", 3)]]></Attributes>
</O>
<PrivilegeControl/>
...
<C c="1" r="7" s="3">
<O t="DSColumn">
<Attributes dsName="ds1" columnName="ZYNDZDLZ"/>
<Condition class="com.fr.data.condition.ListCondition"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Result>
...
<BoundsAttr x="0" y="0" width="900" height="264"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report1"/>
<WidgetAttr description="">
...
<C c="1" r="1" s="0">
<O t="DSColumn">
<Attributes dsName="ds1" columnName="ZYZDLZ_MONTH"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="0" y="493" width="900" height="264"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="783" y="0" width="57" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
...
var url = FR.cjkEncode("/WebReport/ReportServer?reportlet=HXXF_HR%2FHR_QUIT%2FDrivingSeparationRate.cpt&date_time="+date_time1+"&dwmc="+dwmc1+"&format=excel&extype=simple&__filename__="+ res+"_主动离职率（主营）_"+res1);
//alert(0)
...
<BoundsAttr x="840" y="0" width="60" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[723900,1440000,0,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<BoundsAttr x="450" y="0" width="450" height="325"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report2"/>
<WidgetAttr description="">
...
<BoundsAttr x="450" y="757" width="450" height="325"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr4VanChart useHtml="false" floating="false" x="50.0" y="10.0" limitSize="false" maxHeight="15.0"/>
</Title4VanChart>
...
<ChartSummaryColumn name="ZYZDLZL" function="com.fr.data.util.function.NoneFunction" customName="主动离职率"/>
</MoreNameCDDefinition>
</DefinitionMap>
...
<CategoryName value="DESCR2"/>
<ChartSummaryColumn name="ZYNDZDLZ" function="com.fr.data.util.function.NoneFunction" customName="年度主动离职"/>
</MoreNameCDDefinition>
</DefinitionMap>
</DefinitionMapList>
</CustomDefinition>
...
<BoundsAttr x="0" y="0" width="900" height="385"/>
</Widget>
...
<BoundsAttr x="0" y="108" width="900" height="385"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<Content>
<![CDATA[/*window.parent.FS.tabPane.addItem({title:"主动离职率",
	src:
	"${servletURL}?reportlet=/HXXF_HR/HR_QUIT/Management_GB.frm&date_time="+date_time1+"&dwmc="+dwmc1});*/

/*var url = FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR%2FHR_QUIT%2FManagement_GB.frm"); 
FR.doHyperlinkByGet({url:url,title:'Management_ZYFX',target:'_self',date_time:date_time1,dwmc:dwmc1});  */
/*var url = FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR/HR_QUIT/Management_GB.frm&date_time="+date_time1+"&dwmc="+dwmc1);
//alert(0)
window.open(url);*/
location=FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR%2FHR_QUIT%2FManagement_CQT.frm&date_time="+date_time1+"&dwmc="+dwmc1+"&username="+username1);
...
<BoundsAttr x="138" y="0" width="50" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<Content>
<![CDATA[location=FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR%2FHR_QUIT%2FManagement_GB.frm&dwmc="+dwmc1+"&date_time="+date_time1+"&username="+username1); ]]></Content>
</JavaScript>
</Listener>
...
<BoundsAttr x="88" y="0" width="50" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=$username1]]></Attributes>
</O>
</Parameter>
</Parameters>
<Content>
<![CDATA[/*var url = FR.cjkEncode("/WebReport/ReportServer?formlet=HXXF_HR%2FHR_QUIT%2FManagement_monitoring.frm");
FR.doHyperlinkByGet({url:url,title:'Management_monitoring',target:'_self',dwmc:dwmc1}); */
...
<BoundsAttr x="0" y="0" width="88" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="530" y="0" width="126" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D4 = NULL,D4 / ((H4 + F4) / 2),C4 / ((D4 + F4) / 2))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<2,"-", SUM(C4 + B5))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(D5 = NULL,C5 / ((H4 + F5) / 2),C5 / ((D5 + F5) / 2))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<3,"-",SUM(C5+B6))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<4,"-",SUM(C6 + B7))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<5,"-",SUM(C7 + B8))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<6,"-",SUM(C8 + B9))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<7,"-", SUM(C9 + B10))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<8,"-",SUM(C10 + B11))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<9,"-", SUM(C11 + B12))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<10,"-",SUM(C12 + B13))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<11,"-",SUM(C13 + B14))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=IF(MONTH(NOW())<12,"-", SUM(C14 + B15))]]></Attributes>
</O>
<PrivilegeControl/>
<HighlightList>
<Highlight class="com.fr.report.cell.cellattr.highlight.DefaultHighlight">
...
<BoundsAttr x="0" y="0" width="450" height="325"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report0"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="757" width="450" height="325"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="b2deb455-8153-4629-b283-0b789169146d"/>
</Form>
