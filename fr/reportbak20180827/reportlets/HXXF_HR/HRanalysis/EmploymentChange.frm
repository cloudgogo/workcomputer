...
<TableDataMap>
<TableData name="09到现在用工变化" class="com.fr.data.impl.DBTableData">
<Parameters/>
...
<Query>
<![CDATA[SELECT 
TO_CHAR(ZYDATE,'YYYY')||'年' AS NIANDU,
ZYNUM+0 as ZYNUM,
NZYNUM+0 as NZYNUM,
TOTALNUM+0 as TOTALNUM,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')=to_char(sysdate,'yyyy') THEN ZYNUM+0 ELSE null  END as ZYNUM1,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')=to_char(sysdate,'yyyy') THEN NZYNUM+0 ELSE null  END as NZYNUM1,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')=to_char(sysdate,'yyyy') THEN TOTALNUM+0 ELSE null  END as TOTALNUM1
FROM
ODM_HR_HISNUMA
UNION ALL
SELECT '至今' AS NIANDU,
       ...
       TOTALNUM+0 as TOTALNUM,
       14294 as ZYNUM1,
       4153 as NZYNUM1,---3153
       17447 as TOTALNUM1

FROM(
SELECT 
TO_CHAR(SYSDATE,'YYYY') AS NIANDU,
TO_CHAR(B.RENSHU) AS ZYNUM,
TO_CHAR(C.RENSHU) AS NZYNUM,
TO_CHAR(A.RENSHU) AS TOTALNUM
FROM(
SELECT 
...
SELECT TREE_NODE
FROM ODM_HR_DW
  start with TREE_NODE ='HX_HEAD' connect by  PARENT_NODE   =  prior TREE_NODE)
)A,
(
SELECT 
COUNT(DISTINCT YGID) AS RENSHU
...
<TableData name="环比" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<Query>
<![CDATA[SELECT 
substr(TO_char(ZYDATE),1,4)||'. '||substr(TO_char(ZYDATE),5,2) AS ZYDATE,
HZ,
ZY,
FZY,
HZ1,
...
FROM(
SELECT 
CASE WHEN SUBSTR(TO_CHAR(ZYDATE,'yyyymmdd'),5,2)='12' THEN SUBSTR(TO_CHAR(ZYDATE,'yyyymmdd'),1,6) ELSE TO_CHAR(ZYDATE,'yyyymm') END AS ZYDATE,
 TOTALNUM||'.'||0||LAG(TOTALNUM,1,0) over (order by ZYDATE)||1 AS  HZ,
 ZYNUM ||'.'||0|| LAG(ZYNUM,1,0) over (order by ZYDATE)||1 AS ZY,
 NZYNUM ||'.'||0||LAG(NZYNUM,1,0) over (order by ZYDATE)||1 AS  FZY,
 TOTALNUM AS  HZ1,
 ZYNUM  AS ZY1,
 NZYNUM  AS  FZY1
FROM  ODM_HR_HISNUM
WHERE 
TO_CHAR(ZYDATE,'YYYY-MM')<  TO_CHAR(SYSDATE,'YYYY-MM')
AND TO_CHAR(ZYDATE,'YYYYMM') > TO_CHAR(SYSDATE,'YYYY')-1||TO_CHAR(SYSDATE,'MM'))
UNION ALL

SELECT
	TO_CHAR (SYSDATE, 'YYYY. MM')  AS ZYDATE,
	TOTALNUM || '.' || 0 || LastTOTAL || 1 AS HZ,
	ZY || '.' || 0 || LastZY || 1 AS ZY,
	FZY || '.' || 0 || LastFZY || 1 AS FZY,
	TO_CHAR (TOTALNUM) AS HZ1,
	TO_CHAR (ZY) AS ZY1,
	TO_CHAR (FZY) AS FZY1 
FROM
	(
		SELECT
			...
			(
				...
				FROM
					ODM_HR_HISNUM
				WHERE
					TO_CHAR (ZYDATE, 'YYYY-MM') = TO_CHAR (
...
<TableData name="用工环比" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
<![CDATA[SELECT 
riqi,
round(ZY_HB,2) AS ZY_HB,
round(NY_HB,2) AS NY_HB,
round(ZT_HB,2) AS ZT_HB
FROM(
SELECT 
to_char(t1.ZYDATE,'yyyy-mm-dd') as riqi,
t1.ZYNUM/(SELECT t2.ZYNUM FROM ODM_HR_HISNUM t2 WHERE TO_CHAR(t2.ZYDATE,'yyyy-mm') = TO_CHAR(to_date(TO_CHAR(t1.ZYDATE,'yyyy-mm'),'yyyy-mm')-1,'yyyy-mm'))-1 as ZY_HB,
t1.NZYNUM/(SELECT t2.NZYNUM FROM ODM_HR_HISNUM t2 WHERE TO_CHAR(t2.ZYDATE,'yyyy-mm') = TO_CHAR(to_date(TO_CHAR(t1.ZYDATE,'yyyy-mm'),'yyyy-mm')-1,'yyyy-mm'))-1 as NY_HB,
t1.TOTALNUM/(SELECT t2.TOTALNUM FROM ODM_HR_HISNUM t2 WHERE TO_CHAR(t2.ZYDATE,'yyyy-mm') = TO_CHAR(to_date(TO_CHAR(t1.ZYDATE,'yyyy-mm'),'yyyy-mm')-1,'yyyy-mm'))-1 as ZT_HB
FROM
ODM_HR_HISNUM t1)]]></Query>
</TableData>
...
<TableData name="09到现在用工变化数据表" class="com.fr.data.impl.DBTableData">
<Parameters/>
<Attributes maxMemRowCount="-1"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
...
NZYNUM+0 as NZYNUM,
TOTALNUM+0 as TOTALNUM,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')='2017' THEN ZYNUM+0 ELSE null  END as ZYNUM1,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')='2017' THEN NZYNUM+0 ELSE null  END as NZYNUM1,
CASE WHEN TO_CHAR(ZYDATE,'YYYY')='2017' THEN TOTALNUM+0 ELSE null  END as TOTALNUM1
FROM
ODM_HR_HISNUMA
UNION ALL
SELECT '至今' AS NIANDU,
...
<TableData name="每月各单位数据" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
(
 ...
 /*UNION ALL
	 ...
	 TT3 AS (
	 SELECT distinct TREE_NODE_NUM,TDATE,TREE_NODE,PARENT_NODE,DESCR,TREE_NODES,PARENT_NAME,ZRS FROM TT
	 UNION ALL
	 SELECT distinct TREE_NODE_NUM,TDATE,TREE_NODE,PARENT_NODE,DESCR,TREE_NODES,PARENT_NAME,HZS FROM TT2
	 )
	 ...
	 TREE_NODES,
	 PARENT_NAME,
	 ZRS||'.'||0||LAG(ZRS,1,0) over ( partition by TREE_NODE order by TDATE)|| 1 AS  ZRS
	 FROM TT3
	 WHERE TREE_NODE<>'HX_HEAD'
	  AND DESCR<>'公司领导'
	 ORDER BY TREE_NODE_NUM,TDATE desc]]></Query>
</TableData>
...
SELECT 
T1.TREE_NODE_NUM,
TO_CHAR(SYSDATE,'YYYYMM') TDATE,
T1.TREE_NODE,
T1.PARENT_NODE ,
T1.DESCR ,
T1.PARENT_NODES,
T1.PARENT_NAME  ,
COUNT(CASE WHEN ${if(OR(len(FENLEI)==0,FENLEI=2),"1=1","1=0")} THEN YGID 
           WHEN ${if(FENLEI=1,"ISZHUYING='主营'","1=0")} THEN YGID 
	      WHEN ${if(FENLEI=0,"ISZHUYING<>'主营'","1=0")}  THEN YGID END) AS ZRS
FROM odm_hr_ygtz T
LEFT JOIN ODM_HR_DW T1 ON T.bumenid=T1.TREE_NODE
WHERE T1.PARENT_NODE='HX_HEAD'
GROUP BY T1.TREE_NODE_NUM,T1.TREE_NODE,T1.PARENT_NODE ,T1.DESCR ,T1.PARENT_NODES,T1.PARENT_NAME 
...
(
 ...
 /*UNION ALL
     ...
     TT.DESCR	      ,
     TT.TREE_NODES	  ,
     REPLACE(TT.PARENT_NAME,'<','-') PARENT_NAME,
	 TT1.HZS
	 FROM TT LEFT JOIN TT1 ON TT.TREE_NODE=TT1.TREE_NODE
	 ),
	 TT3 AS (
	 ...
	 SUBSTR(TDATE,1,4)||'. '|| SUBSTR(TDATE,5,2) AS TDATE,
	 TREE_NODE,PARENT_NODE,DESCR,TREE_NODES,REPLACE(PARENT_NAME,'<','-') PARENT_NAME,ZRS FROM TT
	 UNION ALL
	 SELECT  DISTINCT TREE_NODE_NUM,
	 SUBSTR(TDATE,1,4)||'. '|| SUBSTR(TDATE,5,2) AS TDATE,
	 TREE_NODE,PARENT_NODE,DESCR,TREE_NODES,REPLACE(PARENT_NAME,'<','-') PARENT_NAME,HZS FROM TT2
	 )
	 
	 SELECT 	
	 TREE_NODE_NUM,
	 CASE WHEN TDATE=(to_char(SYSDATE,'YYYY') ||'. '||to_char(SYSDATE,'MM')) THEN '当前' ELSE TDATE END AS TDATE,
	 TREE_NODE,
	 PARENT_NODE,
	 DESCR,
	 TREE_NODES,
	 REPLACE(PARENT_NAME,'<','-') PARENT_NAME,
	  ...
	  ROUND(CASE WHEN LAG(ZRS,1,0) over ( partition by TREE_NODE order by TDATE)=0  THEN NULL
			 ELSE ZRS/LAG(ZRS,1,0) over ( partition by TREE_NODE order by TDATE) 
					END -1,4) AS RATIO			
	 FROM TT3
	 WHERE TREE_NODE<>'HX_HEAD'
	 AND DESCR<>'公司领导'
...
(
 ...
 /*UNION ALL
	 ...
	 TT3 AS (
	 SELECT  DISTINCT TREE_NODE_NUM,TDATE,TREE_NODE,PARENT_NODE,DESCR,REPLACE(PARENT_NAME,'<','-') PARENT_NAME,TREE_NODES,ZRS FROM TT
	 UNION ALL
	 SELECT  DISTINCT TREE_NODE_NUM,TDATE,TREE_NODE,PARENT_NODE,DESCR,REPLACE(PARENT_NAME,'<','-') PARENT_NAME,TREE_NODES,HZS FROM TT2
	 ),
	 TT5 AS 
	 (	 
	 SELECT 	
	 ...
	 REPLACE(PARENT_NAME,'<','-') PARENT_NAME,
	 ZRS ,
	 ZRS-LAG(ZRS,1,0) over ( partition by TREE_NODE order by TDATE) AS SZHS,
	 ...
	 WHERE TREE_NODE<>'HX_HEAD'
	 AND  DESCR<>'华夏幸福'
	 AND (TDATE= (to_char(sysdate,'yyyy')-1||'12') OR TDATE=to_char(SYSDATE,'YYYYMM'))
	 ORDER BY TREE_NODE_NUM,TDATE
	 )
	 SELECT * FROM TT5
	 
	 where TDATE=(to_char(SYSDATE,'YYYYMM') )
	  AND DESCR<>'公司领导']]></Query>
</TableData>
</TableDataMap>
...
<O>
<![CDATA[WebReport/ReportServer?formlet=HXXF_HR/HRanalysis/EmploymentChange.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT" isKey="false" skipUnmodified="false">
<O>
<![CDATA[EmploymentChange.frm]]></O>
</ColumnConfig>
<ColumnConfig name="CPT_NAME" isKey="false" skipUnmodified="false">
<O>
<![CDATA[人才队伍结构_公司用工变化]]></O>
</ColumnConfig>
...
<WidgetName name="6239ba35-b776-4ab5-acdd-f0162c02d1f4"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
<![CDATA[2009年至今用工总量变化]]></Text>
<FRFont name="SimSun" style="0" size="72"/>
<isCustomType isCustomType="true"/>
<SwitchTagAttr layoutName="tabpane0"/>
</Widget>
<Widget class="com.fr.form.ui.CardSwitchButton">
<WidgetName name="98b6f841-99ba-4fc4-877d-41e8486dd866"/>
<WidgetAttr description="">
<PrivilegeControl/>
</WidgetAttr>
<Text>
<![CDATA[近一年用工人数环比增长趋势]]></Text>
<FRFont name="SimSun" style="0" size="72"/>
<isCustomType isCustomType="true"/>
...
<![CDATA[2781300,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<PrivilegeControl/>
<Expand/>
...
<C c="1" r="0" s="1">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化数据表" columnName="NIANDU"/>
<Complex/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<font color=#7d0000 ; font-weight: bold;>" + "-•-" + " " + "<font color=black>总人数"]]></Attributes>
</O>
<PrivilegeControl/>
...
<C c="1" r="1" s="3">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化数据表" columnName="TOTALNUM"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<Formula>
<![CDATA[B1 = "2018预测值"]]></Formula>
</Condition>
</JoinCondition>
<JoinCondition join="1">
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[B1 = "2019预测值"]]></Formula>
</Condition>
</JoinCondition>
</Condition>
<HighlightAction class="com.fr.report.cell.cellattr.highlight.FRFontHighlightAction">
<FRFont name="SimSun" style="1" size="80" foreground="-3881788"/>
</HighlightAction>
</Highlight>
</HighlightList>
<Expand dir="0"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<font color=#bf0000; font-weight: bold; >" + "-•-" + " " + "<font color=black>主营"]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<C c="1" r="2" s="4">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化数据表" columnName="ZYNUM"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<font color=#585853; font-weight: bold;>" + "-•-" + " " + "<font color=black>非主营"]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<C c="1" r="3" s="5">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化数据表" columnName="NZYNUM"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<Style horizontal_alignment="0" imageLayout="1">
<FRFont name="微软雅黑" style="0" size="72" foreground="-8585216"/>
<Background name="NullBackground"/>
<Border>
<Top style="1" color="-3881788"/>
<Bottom style="1" color="-3881788"/>
...
<Style horizontal_alignment="0" imageLayout="1">
<FRFont name="微软雅黑" style="0" size="72" foreground="-10263971"/>
<Background name="NullBackground"/>
<Border>
<Top style="1" color="-3881788"/>
<Bottom style="1" color="-3881788"/>
...
<BoundsAttr x="0" y="0" width="956" height="156"/>
</Widget>
...
<![CDATA[723900,723900,723900,723900,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[2057400,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<PrivilegeControl/>
<Expand/>
...
<BoundsAttr x="0" y="340" width="956" height="156"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<ColumnWidth defaultValue="2743200">
<![CDATA[381000,3390900,2019300,2362200,2590800,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="截止至" + YEAR(NOW(), 4) + "年" + MONTH(NOW(), 6, 2) + "月" + DAY(NOW(), 9, 2) + "日，"+"<span style='color:#bf0008; font-weight: bold;'>"+"华夏幸福"+"</span>"+"共有员工" + "<span style='color:#bf0008; font-weight: bold;'>"+ D2+ "</span>" + CONCATENATE("<font color=#000000 font-weight: bold;>", "人，其中，主营人员", "<font color=#000000 sont-weight: bold;>") +"<span style='color:#bf0008; font-weight: bold;'>"+ B2+ "</span>" + CONCATENATE("<font color=#000000 sont-weight: bold;>", "人，非主营人员", "<font color=#000000 sont-weight: bold;>") + "<span style='color:#bf0008; font-weight: bold;'>"+ C2+ "</span>"+ CONCATENATE("<font color=#000000 sont-weight: bold;>", "人，自2009年至今，用工增长趋势变化如下", "<font color=#000000 sont-weight: bold;>")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<C c="1" r="1">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化" columnName="ZYNUM"/>
...
<C c="2" r="1">
<O t="DSColumn">
<Attributes dsName="09到现在用工变化" columnName="NZYNUM"/>
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
<![CDATA[0]]></CNUMBER>
<CNAME>
...
<C c="3" r="1">
<O t="DSColumn">
<Attributes dsName="总人数" columnName="RENSHU"/>
<Complex/>
<RG class="com.fr.report.cell.cellattr.core.group.FunctionGrouper"/>
<Parameters/>
</O>
...
<BoundsAttr x="0" y="0" width="956" height="64"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report0"/>
<WidgetAttr description="">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="截止至" + YEAR(NOW(), 4) + "年" + MONTH(NOW(), 6, 2) + "月" + DAY(NOW(), 9, 2) + "日，华夏幸福共有员工" + CONCATENATE("<font color=#bf0008 sont-weight: bold;>", " 14079 ", "<font color=#bf0008 sont-weight: bold;>") + CONCATENATE("<font color=#000000 sont-weight: bold;>", "人，其中，主营人员", "<font color=#000000 sont-weight: bold;>") + CONCATENATE("<font color=#bf0008 sont-weight: bold;>", " 11308 ", "<font color=#bf0008 sont-weight: bold;>") + CONCATENATE("<font color=#000000 sont-weight: bold;>", "人，非主营人员", "<font color=#000000 sont-weight: bold;>") + CONCATENATE("<font color=#bf0008 sont-weight: bold;>", " 2771 ", "<font color=#bf0008 sont-weight: bold;>") + CONCATENATE("<font color=#000000 sont-weight: bold;>", "人，自2009年至今，用工增长趋势变化如下", "<font color=#000000 sont-weight: bold;>")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr showAsHTML="true"/>
<CellPageAttr/>
...
<AttrBackground>
<Background name="ColorBackground" color="-4325367"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-8650752"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="72" foreground="-3881788"/>
</Attr>
</TextAttr>
<AttrToolTipContent>
<Attr isCommon="true"/>
...
<HtmlLabel customText="function(){ return this.seriesName+&quot;:&quot;+(this.value-1000);}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
<Background name="ColorBackground" color="-16777216"/>
...
<HtmlLabel customText="function(){ return this.value-1000+&quot;(预测)&quot;;}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
</labelDetail>
</AttrLabel>
</Attr>
...
<FormulaDictAttr kiName="ZYNUM" viName="ZYNUM1"/>
<TableDataDictAttr>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[09到现在用工变化]]></Name>
</TableData>
</TableDataDictAttr>
</Dictionary>
</CategoryPresent>
...
<CategoryName value="NIANDU"/>
<ChartSummaryColumn name="TOTALNUM" function="com.fr.data.util.function.NoneFunction" customName="总人数"/>
<ChartSummaryColumn name="ZYNUM" function="com.fr.data.util.function.NoneFunction" customName="主营"/>
<ChartSummaryColumn name="NZYNUM" function="com.fr.data.util.function.NoneFunction" customName="非主营"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<BoundsAttr x="0" y="0" width="956" height="276"/>
</Widget>
...
<ChartSummaryColumn name="主营" function="com.fr.data.util.function.NoneFunction" customName="主营"/>
<ChartSummaryColumn name="非主营" function="com.fr.data.util.function.NoneFunction" customName="非主营"/>
<ChartSummaryColumn name="总数" function="com.fr.data.util.function.NoneFunction" customName="总数"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<BoundsAttr x="0" y="64" width="956" height="276"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<HtmlLabel customText="function(){if(this.value.toString().split(&apos;.&apos;)[1]==&apos;001&apos;) { return this.seriesName+&quot;:&quot;+parseInt(this.value) } else { return this.seriesName+&quot;:&quot;+parseInt(this.value) +&quot;&lt;/br&gt;&quot;+&quot;环比:&quot; + ((parseInt(this.value)/this.value.toString().split(&apos;.&apos;)[1].substring(0,this.value.toString().split(&apos;.&apos;)[1].length-1)-1)*100).toFixed(2)+&quot;%&quot;;} }" useHtml="false" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
</labelDetail>
</AttrLabel>
</Attr>
...
<HtmlLabel customText="function(){if(this.value.toString().split(&apos;.&apos;)[1]==&apos;001&apos;) { return this.seriesName+&quot;:&quot;+parseInt(this.value) } else { return this.seriesName+&quot;:&quot;+parseInt(this.value) +&quot;&lt;/br&gt;&quot;+&quot;环比:&quot; + ((parseInt(this.value)/this.value.toString().split(&apos;.&apos;)[1].substring(0,this.value.toString().split(&apos;.&apos;)[1].length-1)-1)*100).toFixed(1)+&quot;%&quot;;} }" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
<Background name="ColorBackground" color="-16777216"/>
...
<Attr class="com.fr.chart.base.AttrBackground">
<AttrBackground>
<Background name="ColorBackground" color="-9209476"/>
<Attr shadow="false"/>
</AttrBackground>
</Attr>
</AttrList>
...
<OColor colvalue="-39220"/>
<OColor colvalue="-6684775"/>
...
<newAxisAttr isShowAxisLabel="true"/>
<AxisLineStyle AxisStyle="0" MainGridStyle="1"/>
<newLineColor mainGridColor="-2302756" lineColor="-5197648"/>
<AxisPosition value="2"/>
<TickLine201106 type="2" secType="0"/>
<ArrowShow arrowShow="false"/>
<TextAttr>
...
<CategoryName value="ZYDATE"/>
<ChartSummaryColumn name="HZ" function="com.fr.data.util.function.NoneFunction" customName="总人数"/>
<ChartSummaryColumn name="ZY" function="com.fr.data.util.function.NoneFunction" customName="主营"/>
<ChartSummaryColumn name="FZY" function="com.fr.data.util.function.NoneFunction" customName="非主营"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<ChartSummaryColumn name="主营" function="com.fr.data.util.function.NoneFunction" customName="主营"/>
<ChartSummaryColumn name="非主营" function="com.fr.data.util.function.NoneFunction" customName="非主营"/>
<ChartSummaryColumn name="总人数" function="com.fr.data.util.function.NoneFunction" customName="总人数"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[576000,576000,576000,432000,723900,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
<![CDATA[288000,3772800,1872000,1872000,1872000,1872000,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0">
<PrivilegeControl/>
<Expand/>
...
<C c="2" r="2" s="3">
<O t="DSColumn">
<Attributes dsName="对比年初增长" columnName="SZHS"/>
<Condition class="com.fr.data.condition.ListCondition">
<JoinCondition join="0">
<Condition class="com.fr.data.condition.CommonCondition">
<CNUMBER>
...
<BoundsAttr x="0" y="0" width="956" height="201"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report3"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="295" width="956" height="201"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<HtmlLabel customText="function(){if(this.value.toString().split(&apos;.&apos;)[1]==&apos;001&apos;) { return this.seriesName+&quot;:&quot;+parseInt(this.value) } else { return this.seriesName+&quot;:&quot;+parseInt(this.value) +&quot;&lt;/br&gt;&quot;+&quot;环比:&quot; + ((parseInt(this.value)/this.value.toString().split(&apos;.&apos;)[1].substring(0,this.value.toString().split(&apos;.&apos;)[1].length-1)-1)*100).toFixed(1)+&quot;%&quot;;} }" useHtml="false" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
<Background name="ColorBackground" color="-16777216"/>
...
<OColor colvalue="-16731457"/>
<OColor colvalue="-11460720"/>
<OColor colvalue="-8912798"/>
<OColor colvalue="-7056635"/>
<OColor colvalue="-1276146"/>
<OColor colvalue="-677734"/>
<OColor colvalue="-4013374"/>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="Verdana" style="1" size="88" foreground="-10066330"/>
</Attr>
</TextAttr>
<TitleVisible value="true" position="0"/>
</Title>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="DESCR" valueName="ZRS" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[每月各单位数据]]></Name>
</TableData>
<CategoryName value="TDATE"/>
...
<BoundsAttr x="0" y="0" width="956" height="233"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart2"/>
<WidgetAttr description="">
...
<BoundsAttr x="0" y="62" width="956" height="233"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<RowPrivilegeControl/>
<RowHeight defaultValue="723900">
<![CDATA[144000,1008000,144000,685800,144000,723900,723900,723900,723900,723900,723900]]></RowHeight>
<ColumnWidth defaultValue="2743200">
...
<BoundsAttr x="0" y="0" width="956" height="62"/>
</Widget>
<body class="com.fr.form.ui.ElementCaseEditor">
<WidgetName name="report2"/>
<WidgetAttr description="">
...
<TemplateID TemplateID="45ce0f02-7f9d-42c8-be91-199a8dbd9967"/>
</Form>
