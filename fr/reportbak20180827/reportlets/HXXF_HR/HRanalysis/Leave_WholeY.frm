...
AND YGLEIBIE NOT LIKE '%实习生%'
${if(len(DWMC)=0,"and 1=1"," and TREE_NODE_ID LIKE '%"+DWMC+",%'")}
GROUP BY LZLEIXING ORDER BY LZLEIXING DESC)
UNION ALL
SELECT
RENSHU,
'总体-'||LZLEIXING AS LZLEIXING
...
${if(len(DWMC)=0,"and 1=1"," and TREE_NODE_ID LIKE '%"+DWMC+",%'")}
GROUP BY LZLEIXING ORDER BY LZLEIXING DESC)]]></Query>
</TableData>
...
AND TO_CHAR(LZDATE,'YYYYMMDD')<TO_CHAR(SYSDATE,'YYYYMMDD')
${if(len(DWMC)=0,"and 1=1"," and TREE_NODE_ID LIKE '%"+DWMC+",%'")}
${SWITCH(FENLEI,'',"",'总体',"",'总体-辞职',"AND LZLEIXING='辞职'",'总体-辞退',"AND LZLEIXING='辞退'",'主营'," AND ISZHUYING  ='主营'",'主营-辞职',"AND LZLEIXING='辞职' AND ISZHUYING  ='主营'",'主营-辞退',"AND LZLEIXING='辞退' AND ISZHUYING  ='主营'",'非主营'," AND ISZHUYING !='主营'",'非主营-辞职',"AND LZLEIXING='辞职' AND ISZHUYING !='主营'",'非主营-辞退',"AND LZLEIXING='辞退' AND ISZHUYING !='主营'")}
...
AND YGLEIBIE NOT LIKE '%实习生%'
AND ISSYQLZ = '是'
${switch(FENLEI,'',"",'总体',"",'总体-辞职',"AND LZLEIXING = '辞职'",'总体-辞退',"AND LZLEIXING = '辞退'",'主营',"AND ISZHUYING = '主营'",'主营-辞职',"AND LZLEIXING = '辞职' AND ISZHUYING = '主营'",'主营-辞退',"AND LZLEIXING = '辞退' AND ISZHUYING = '主营'",'非主营',"AND LZLEIXING = '辞职' AND ISZHUYING !='主营'",'非主营-辞职',"AND LZLEIXING = '辞职' AND ISZHUYING !='主营'",'非主营-辞退',"AND LZLEIXING = '辞退' AND ISZHUYING !='主营'")}
${if(len(DWMC)=0,"and 1=1"," and TREE_NODE_ID LIKE '%"+DWMC+",%'")}
 )
...
<BoundsAttr x="693" y="0" width="153" height="35"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(seadate)==0 || seadate == year(now()),"本年度",seadate+"年度")+"骨干离职（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len(seadate)==0 || seadate == year(now()),"本年度",seadate+"年度")+"各单位离职分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="离职原因分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
<FRFont name="微软雅黑" style="0" size="104" foreground="-13421773"/>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="各月度离职分布（"+if(len($FENLEI)=0,"总体",$FENLEI)+"）"]]></Attributes>
</O>
<TextAttr>
<Attr alignText="0">
...
<TemplateID TemplateID="da5433f9-f574-4e11-8a0d-f1d143238dd1"/>
</Form>
