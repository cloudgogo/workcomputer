...
<![CDATA[with tab1 as (
 select res.DATA_DATE,
       res.store_mon,
       round(sum(res.store_value),1) store_value,
       res.org_classify,
 ...
 group by res.DATA_DATE, res.store_mon, res.org_classify
 )


 ,
tab2 as (    select org_classify, sum(nvl(store_value, 0)) value from tab1 group by org_classify )

--select * from tab2


select * from (
 select tab1.org_classify, tab1.typevalue, tab1.store_value,  
 	case when nvl(tab2.value, 0)=0 then 0
 	else tab1.store_value/tab2.value end rate 
 from tab1, tab2 
 where tab1.org_classify=tab2.org_classify
 )

 where 1=1
 --and rate>=0.02

 order by org_classify, typevalue, store_value
]]></Query>
</TableData>
...
<Query>
<![CDATA[
select round(sum(f.store_value),1) store_value, f.formate_id
...
<![CDATA[select *
  ...
  left join (SELECT *
               FROM (select substr(a.data_month, 5, 2) || '月' 月份,
                            round(sum(a.house_target),1) 年度目标,
...
<Query>
<![CDATA[with result as ( select r.res_sche_id , r.all_value  from dm_res_check_res_sche r
where r.org_id in (select org_id from dim_org where org_type ='事业部')
 union all 
 select '已取证' res_sche_id,VALUE all_value  from  dm_res_OPERATEVALUE o
 where o.year=(select substr(max(data_date),1,4) from dm_res_check_res_sche ))

select r.res_sche_id,sum(r.all_value) store_value,sum(r.all_value)/(select sum(all_value) from  result) rate from result r group by r.res_sche_id]]></Query>
</TableData>
...
<![CDATA[ select * from  (
   ...
   select case when round((nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) ,1)<1 then (case when round((nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) ,1)>-1 then ORG_SNAME||'-0'||round((nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) ,1) else ORG_SNAME||'-'||round((nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) ,1) end )else  ORG_SNAME||'-'||round((nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) ,1)  end ORG_SNAME,round(nvl(sum(first),0),1) first,round(nvl(sum(second),0),1) second,round(nvl(sum(thrid),0),1) thrid,round(nvl(sum(fourth),0),1) fourth,(nvl(sum(first),0)+nvl(sum(second),0)+nvl(sum(thrid),0)+nvl(sum(fourth),0)) sumvalue,orderkey from  (      
       select  ORG_SNAME,store_mon,case store_mon when '0~3月(亿元)' then nvl(store_value,0) end first ,
case store_mon when '3~6月(亿元)' then nvl(store_value,0) end second,
case store_mon when '6~12月(亿元)' then nvl(store_value,0) end thrid,
case store_mon when '一年以上(亿元)' then nvl(store_value,0) end fourth,       
       store_value,
       sumvalue,orderkey from (     
            select res.ORG_SNAME,res.store_mon||'(亿元)' store_mon,sum(store_value) store_value,sumvalue,dense_rank() over (  order by sumvalue ${if(ordertype="后十名","asc","desc")}) orderkey from (
               ...
               order by    
               ${if(parm<=2,"sum(result.store_value) over(partition by result.org_sname)","result.store_value")} desc  ,STORE_MON 

               )
               group by ORG_SNAME,sumvalue,orderkey

               )
               order by sumvalue desc, orderkey,ORG_SNAME]]></Query>
</TableData>
</TableDataMap>
<FormMobileAttr>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($info)=0,"否",if($info=$info99,"否","是"))]]></Attributes>
</O>
</ColumnConfig>
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($info)=0,"",if($info=$info99,"",$info))]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="LIANJIEMINGYUCANSHU" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[=if(len($info)=0,"",if($info=$info99,"","info:"+switch($info,"房源详情","ThreeLevelPage/OPE_FIN_FANGYUAN.cpt")))]]></Attributes>
</O>
</ColumnConfig>
<ColumnConfig name="DATA_DATE" isKey="false" skipUnmodified="false">
<O t="Formula" class="Formula">
...
<Condition class="com.fr.data.condition.FormulaCondition">
<Formula>
<![CDATA[if(len($info)=0,1<0,if($info=$info99,1<0,0<1))]]></Formula>
</Condition>
</JoinCondition>
</Condition>
</DMLConfig>
...
this.options.form.getWidgetByName("ordertype99").setValue(ordertype);
...
<BoundsAttr x="220" y="149" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="220" y="126" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="222" y="99" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="224" y="73" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="531" y="308" width="160" height="24"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Parameters/>
<Content>
<![CDATA[window.parent.FS.tabPane.addItem({title:"房源详情",src:"${servletURL}?reportlet=ThreeLevelPage%2FOPE_FIN_FANGYUAN.cpt&__bypagesize__=false"})]]></Content>
</JavaScript>
</NameJavaScript>
...
<Features/>
<realateName realateValue="report2_1_t"/>
<linkType type="1"/>
</JavaScript>
</JavaScript>
</NameJavaScript>
...
<BoundsAttr x="352" y="37" width="69" height="19"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="432" y="264" width="180" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="819" y="261" width="27" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=max(value(&quot;2-list-1-update&quot;,6))*1.3"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<ChartSummaryColumn name="FIRST" function="com.fr.data.util.function.NoneFunction" customName="0~3月(亿元)"/>
<ChartSummaryColumn name="SECOND" function="com.fr.data.util.function.NoneFunction" customName="3~6月(亿元)"/>
<ChartSummaryColumn name="THRID" function="com.fr.data.util.function.NoneFunction" customName="6~12月(亿元)"/>
<ChartSummaryColumn name="FOURTH" function="com.fr.data.util.function.NoneFunction" customName="一年以上(亿元)"/>
</MoreNameCDDefinition>
</DefinitionMap>
...
<BoundsAttr x="432" y="261" width="414" height="211"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="432" y="37" width="180" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="432" y="32" width="414" height="229"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<ColumnWidth defaultValue="2743200">
<![CDATA[4229100,864000,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200,2743200]]></ColumnWidth>
<CellElementList>
<C c="0" r="0" s="0">
<O t="Formula" class="Formula">
<Attributes>
...
<CellGUIAttr>
<ToolTipText>
<![CDATA[=c1+c2+c3+c4+c5+c6]]></ToolTipText>
</CellGUIAttr>
<CellPageAttr/>
<Expand/>
</C>
...
<C c="2" r="3">
<O>
<![CDATA[2、已取地未开工：房源项目已经摘牌，但未进场或未进行土方/桩基施工；\\n]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="0" r="4">
...
<C c="2" r="4">
<O>
<![CDATA[3、已开工未取预售：房源项目已经进场施工，但未取得预售证；\\n]]></O>
<PrivilegeControl/>
<Expand/>
</C>
<C c="0" r="5">
...
<C c="2" r="5">
<O>
<![CDATA[4、已取证：房源项目已经取得预售证（包含已经销售的部分）。\\n]]></O>
<PrivilegeControl/>
<Expand/>
</C>
</CellElementList>
...
<BoundsAttr x="9" y="360" width="119" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="9" y="37" width="180" height="27"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<FRFont name="微软雅黑" style="0" size="64" foreground="-13324042"/>
<Background name="NullBackground"/>
<Border/>
</Style>
...
<FRFont name="微软雅黑" style="0" size="64" foreground="-6823697"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style horizontal_alignment="0" imageLayout="1">
...
<Style imageLayout="1">
<FRFont name="SimSun" style="0" size="72"/>
<Background name="ColorBackground" color="-13324042"/>
<Border/>
</Style>
<Style imageLayout="1">
<FRFont name="SimSun" style="0" size="72"/>
...
<Style imageLayout="1">
<FRFont name="SimSun" style="0" size="72"/>
<Background name="ColorBackground" color="-6823697"/>
<Border/>
</Style>
<Style imageLayout="1">
<FRFont name="SimSun" style="0" size="72" foreground="-6684673"/>
<Background name="ColorBackground" color="-11972425"/>
<Border/>
</Style>
<Style horizontal_alignment="0" textStyle="2" imageLayout="1" paddingLeft="0" paddingRight="0">
...
<Style horizontal_alignment="0" textStyle="1" imageLayout="1" paddingLeft="0" paddingRight="0">
<FRFont name="微软雅黑" style="0" size="64" foreground="-11972425"/>
<Background name="NullBackground"/>
<Border/>
</Style>
<Style horizontal_alignment="0" imageLayout="1">
...
<BoundsAttr x="9" y="351" width="414" height="121"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="report1_1"/>
...
<AxisLabelCount value="=1"/>
<AxisRange maxValue="=max(value(&quot;3-list&quot;,3),value(&quot;3-list&quot;,4))*1.2"/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=0" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
<VanChartAxisAttr mainTickLine="0" secTickLine="0" axisName="Y轴" titleUseHtml="false" autoLabelGap="true" limitSize="false" maxHeight="15.0" commonValueFormat="true" isRotation="false"/>
...
<VanChartColumnPlotAttr seriesOverlapPercent="5.0" categoryIntervalPercent="20.0" fixedWidth="true" columnWidth="20" filledWithImage="false" isBar="false"/>
</VanChartPlot>
<VanChartPlot class="com.fr.plugin.chart.line.VanChartLinePlot">
<VanChartPlotVersion version="20170715"/>
<GI>
...
<BoundsAttr x="9" y="32" width="414" height="320"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
SELECT max(data_date) data_date from  DM_RES_CHECK_HOUSE_ANNUAL
union all
...
<BoundsAttr x="616" y="2" width="227" height="27"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="f4897bf4-7747-44f1-b819-902000ad2c61"/>
